...
main(int argc, char **argv)
{
  ...
  50:	7cc58593          	addi	a1,a1,1996 # 818 <malloc+0xfe>
  54:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3dc:	0805c063          	bltz	a1,45c <printint+0x92>
  neg = 0;
 3e0:	4e01                	li	t3,0
    x = -xx;
  } else {
 ...
 3ee:	4a680813          	addi	a6,a6,1190 # 890 <digits>
 3f2:	88be                	mv	a7,a5
 ...
 442:	f6a080e7          	jalr	-150(ra) # 3a8 <putc>
  while(--i >= 0)
 446:	39fd                	addiw	s3,s3,-1
 448:	14fd                	addi	s1,s1,-1
 44a:	fe09d7e3          	bgez	s3,438 <printint+0x6e>
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 49c:	f10080e7          	jalr	-240(ra) # 3a8 <putc>
 ...
 4e0:	35c70713          	addi	a4,a4,860 # 838 <malloc+0x11e>
 ...
 4fe:	ed0080e7          	jalr	-304(ra) # 3ca <printint>
 502:	8bca                	mv	s7,s2
      } else {
 ...
 51a:	eb4080e7          	jalr	-332(ra) # 3ca <printint>
 51e:	8bca                	mv	s7,s2
      state = 0;
 520:	4981                	li	s3,0
 ...
 536:	e98080e7          	jalr	-360(ra) # 3ca <printint>
 53a:	8bca                	mv	s7,s2
      state = 0;
 53c:	4981                	li	s3,0
 ...
 554:	e58080e7          	jalr	-424(ra) # 3a8 <putc>
  putc(fd, 'x');
 558:	07800593          	li	a1,120
 55c:	8556                	mv	a0,s5
 55e:	00000097          	auipc	ra,0x0
 562:	e4a080e7          	jalr	-438(ra) # 3a8 <putc>
 566:	4941                	li	s2,16
 ...
 580:	e2c080e7          	jalr	-468(ra) # 3a8 <putc>
 ...
 5ac:	e00080e7          	jalr	-512(ra) # 3a8 <putc>
          s++;
 ...
 5c2:	27290913          	addi	s2,s2,626 # 830 <malloc+0x116>
        while(*s != 0){
 ...
 5da:	dd2080e7          	jalr	-558(ra) # 3a8 <putc>
 5de:	8bca                	mv	s7,s2
      state = 0;
 5e0:	4981                	li	s3,0
 ...
 5ee:	dbe080e7          	jalr	-578(ra) # 3a8 <putc>
      state = 0;
 5f2:	4981                	li	s3,0
...
free(void *ap)
{
 ...
 6a4:	2087b783          	ld	a5,520(a5) # 8a8 <freep>
 6a8:	a02d                	j	6d2 <free+0x3e>
 ...
 6c4:	a091                	j	708 <free+0x74>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 6c6:	6398                	ld	a4,0(a5)
 6c8:	00e7e463          	bltu	a5,a4,6d0 <free+0x3c>
 6cc:	00e6ea63          	bltu	a3,a4,6e0 <free+0x4c>
{
 6d0:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 6d2:	fed7fae3          	bgeu	a5,a3,6c6 <free+0x32>
 6d6:	6398                	ld	a4,0(a5)
 6d8:	00e6e463          	bltu	a3,a4,6e0 <free+0x4c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 6dc:	fee7eae3          	bltu	a5,a4,6d0 <free+0x3c>
  if(bp + bp->s.size == p->s.ptr){
 ...
 6f0:	fae60de3          	beq	a2,a4,6aa <free+0x16>
    bp->s.ptr = p->s.ptr->s.ptr;
 ...
 704:	fae68ae3          	beq	a3,a4,6b8 <free+0x24>
    p->s.ptr = bp->s.ptr;
 708:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
 ...
 70e:	18f73f23          	sd	a5,414(a4) # 8a8 <freep>
}
 712:	60a2                	ld	ra,8(sp)
 714:	6402                	ld	s0,0(sp)
...
malloc(uint nbytes)
{
 ...
 73c:	17053503          	ld	a0,368(a0) # 8a8 <freep>
 ...
 768:	14448493          	addi	s1,s1,324 # 8a8 <freep>
  if(p == (char*)-1)
 76c:	5afd                	li	s5,-1
 ...
 77c:	13878793          	addi	a5,a5,312 # 8b0 <base>
 780:	00000717          	auipc	a4,0x0
 784:	12f73423          	sd	a5,296(a4) # 8a8 <freep>
 788:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7be:	bd6080e7          	jalr	-1066(ra) # 390 <sbrk>
  if(p == (char*)-1)
