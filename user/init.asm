...
free(void *ap)
{
 ...
 710:	27c7b783          	ld	a5,636(a5) # 988 <freep>
 ...
 738:	00e6ea63          	bltu	a3,a4,74c <free+0x4a>
{
 ...
 77a:	20f73923          	sd	a5,530(a4) # 988 <freep>
}
 77e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7a4:	1e853503          	ld	a0,488(a0) # 988 <freep>
 ...
 7d4:	1b890913          	addi	s2,s2,440 # 988 <freep>
  if(p == (char*)-1)
 7d8:	5afd                	li	s5,-1
 ...
 7e8:	1ac78793          	addi	a5,a5,428 # 990 <base>
 7ec:	00000717          	auipc	a4,0x0
 7f0:	18f73e23          	sd	a5,412(a4) # 988 <freep>
 7f4:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 866:	12a73323          	sd	a0,294(a4) # 988 <freep>
      return (void*)(p + 1);
