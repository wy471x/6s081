...
testcall() {
 ...
 1e4:	b5b50513          	addi	a0,a0,-1189 # ffffffffeaeb0b5b <__global_pointer$+0xffffffffeaeaf6aa>
...
strcpy(char *s, const char *t)
{
 ...
 34e:	0800                	addi	s0,sp,16
  ...
  while((*s++ = *t++) != 0)
 350:	87aa                	mv	a5,a0
 352:	0585                	addi	a1,a1,1 # fffffffffffff001 <__global_pointer$+0xffffffffffffdb50>
...
gets(char *buf, int max)
{
 ...
 45a:	00098023          	sb	zero,0(s3) # 1000 <__BSS_END__+0x330>
  return buf;
}
 45e:	855e                	mv	a0,s7
...
free(void *ap)
{
 ...
 972:	34a7b783          	ld	a5,842(a5) # cb8 <freep>
 ...
 99a:	00e6ea63          	bltu	a3,a4,9ae <free+0x4a>
{
 ...
 9dc:	2ef73023          	sd	a5,736(a4) # cb8 <freep>
}
 9e0:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 a06:	2b653503          	ld	a0,694(a0) # cb8 <freep>
 ...
 a36:	28690913          	addi	s2,s2,646 # cb8 <freep>
  if(p == (char*)-1)
 a3a:	5afd                	li	s5,-1
 ...
 a4a:	27a78793          	addi	a5,a5,634 # cc0 <base>
 a4e:	00000717          	auipc	a4,0x0
 a52:	26f73523          	sd	a5,618(a4) # cb8 <freep>
 a56:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 ac8:	1ea73a23          	sd	a0,500(a4) # cb8 <freep>
      return (void*)(p + 1);
