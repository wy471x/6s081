...
free(void *ap)
{
 ...
 642:	1f27b783          	ld	a5,498(a5) # 830 <freep>
 ...
 66a:	00e6ea63          	bltu	a3,a4,67e <free+0x4a>
{
 ...
 6ac:	18f73423          	sd	a5,392(a4) # 830 <freep>
}
 6b0:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 6d6:	15e53503          	ld	a0,350(a0) # 830 <freep>
 ...
 706:	12e90913          	addi	s2,s2,302 # 830 <freep>
  if(p == (char*)-1)
 70a:	5afd                	li	s5,-1
 ...
 71a:	12278793          	addi	a5,a5,290 # 838 <base>
 71e:	00000717          	auipc	a4,0x0
 722:	10f73923          	sd	a5,274(a4) # 830 <freep>
 726:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 798:	08a73e23          	sd	a0,156(a4) # 830 <freep>
      return (void*)(p + 1);
