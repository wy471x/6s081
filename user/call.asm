...
void main(void) {
  ...
  2c:	7e050513          	addi	a0,a0,2016 # 808 <malloc+0x102>
  30:	00000097          	auipc	ra,0x0
  34:	61e080e7          	jalr	1566(ra) # 64e <printf>
  unsigned int i = 0x00646c72;
  38:	006477b7          	lui	a5,0x647
  3c:	c7278793          	addi	a5,a5,-910 # 646c72 <__global_pointer$+0x645bc9>
  40:	fef42623          	sw	a5,-20(s0)
	printf("H%x Wo%s", 57616, &i);
  44:	fec40613          	addi	a2,s0,-20
  48:	65b9                	lui	a1,0xe
  4a:	11058593          	addi	a1,a1,272 # e110 <__global_pointer$+0xd067>
  4e:	00000517          	auipc	a0,0x0
  52:	7ca50513          	addi	a0,a0,1994 # 818 <malloc+0x112>
  56:	00000097          	auipc	ra,0x0
  5a:	5f8080e7          	jalr	1528(ra) # 64e <printf>
  printf("x=%d y=%d", 3);
  5e:	458d                	li	a1,3
  60:	00000517          	auipc	a0,0x0
  64:	7c850513          	addi	a0,a0,1992 # 828 <malloc+0x122>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4d0:	37470713          	addi	a4,a4,884 # 840 <malloc+0x13a>
 ...
 55c:	340b8b93          	addi	s7,s7,832 # 898 <digits>
 ...
 5b2:	28a90913          	addi	s2,s2,650 # 838 <malloc+0x132>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 756:	15e90913          	addi	s2,s2,350 # 8b0 <freep>
  if(p == (char*)-1)
 75a:	5afd                	li	s5,-1
 ...
 76a:	15278793          	addi	a5,a5,338 # 8b8 <base>
