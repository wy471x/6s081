...
free(void *ap)
{
 ...
 724:	2307b783          	ld	a5,560(a5) # 950 <freep>
...
malloc(uint nbytes)
{
 ...
 7b8:	19c53503          	ld	a0,412(a0) # 950 <freep>
 ...
 7e8:	16c90913          	addi	s2,s2,364 # 950 <freep>
  if(p == (char*)-1)
 7ec:	5afd                	li	s5,-1
 ...
 7fc:	16078793          	addi	a5,a5,352 # 958 <base>
 800:	00000717          	auipc	a4,0x0
 804:	14f73823          	sd	a5,336(a4) # 950 <freep>
 808:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 87a:	0ca73d23          	sd	a0,218(a4) # 950 <freep>
      return (void*)(p + 1);
