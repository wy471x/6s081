 ...
 */
    ...
    lo = x % 127773;
      16:	66fd                	lui	a3,0x1f
      18:	31d68693          	addi	a3,a3,797 # 1f31d <__global_pointer$+0x1d414>
      1c:	02d7e733          	rem	a4,a5,a3
    x = 16807 * lo - 2836 * hi;
      20:	6611                	lui	a2,0x4
      22:	1a760613          	addi	a2,a2,423 # 41a7 <__global_pointer$+0x229e>
      26:	02c70733          	mul	a4,a4,a2
    hi = x / 127773;
      2a:	02d7c7b3          	div	a5,a5,a3
    x = 16807 * lo - 2836 * hi;
      2e:	76fd                	lui	a3,0xfffff
      30:	4ec68693          	addi	a3,a3,1260 # fffffffffffff4ec <__global_pointer$+0xffffffffffffd5e3>
...
go(int which_child)
{
  ...
  int fd = -1;
    ...
    int what = rand() % 23;
     ...
     236:	4ee58593          	addi	a1,a1,1262 # 1720 <buf.0>
     23a:	8552                	mv	a0,s4
     ...
     24e:	4d658593          	addi	a1,a1,1238 # 1720 <buf.0>
     252:	8552                	mv	a0,s4
     ...
     3b4:	a5a080e7          	jalr	-1446(ra) # e0a <exit>
      ...
      sbrk(6011);
     3b8:	6505                	lui	a0,0x1
     3ba:	77b50513          	addi	a0,a0,1915 # 177b <buf.0+0x5b>
...
iter()
{
  ...
  if(pid1 == 0){
    ...
    rand_next = 31;
     ...
     aae:	c6f73323          	sd	a5,-922(a4) # 1710 <rand_next>
    go(0);
     ab2:	4501                	li	a0,0
  ...
  if(pid2 == 0){
    ...
    rand_next = 7177;
     aec:	6789                	lui	a5,0x2
     aee:	c0978793          	addi	a5,a5,-1015 # 1c09 <__BSS_END__+0xf1>
     af2:	00001717          	auipc	a4,0x1
     af6:	c0f73f23          	sd	a5,-994(a4) # 1710 <rand_next>
    go(1);
     afa:	4505                	li	a0,1
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    11b6:	5667b783          	ld	a5,1382(a5) # 1718 <freep>
    ...
    11de:	00e6ea63          	bltu	a3,a4,11f2 <free+0x4a>
{
  ...
  freep = p;
    ...
    1220:	4ef73e23          	sd	a5,1276(a4) # 1718 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    124a:	4d253503          	ld	a0,1234(a0) # 1718 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    127a:	4a290913          	addi	s2,s2,1186 # 1718 <freep>
  if(p == (char*)-1)
    127e:	5afd                	li	s5,-1
    ...
    128e:	87e78793          	addi	a5,a5,-1922 # 1b08 <base>
    1292:	00000717          	auipc	a4,0x0
    1296:	48f73323          	sd	a5,1158(a4) # 1718 <freep>
  ...
  if(p == (char*)-1)
    ...
    130c:	40a73823          	sd	a0,1040(a4) # 1718 <freep>
      return (void*)(p + 1);
