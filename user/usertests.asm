...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	ff250513          	addi	a0,a0,-14 # 6030 <malloc+0xfa>
      46:	00006097          	auipc	ra,0x6
      4a:	e34080e7          	jalr	-460(ra) # 5e7a <printf>
      exit(1);
      4e:	4505                	li	a0,1
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
      ...
      5c:	93878793          	addi	a5,a5,-1736 # 9990 <uninit>
      60:	0000c697          	auipc	a3,0xc
      64:	04068693          	addi	a3,a3,64 # c0a0 <buf>
    if(uninit[i] != '\0'){
      ...
      74:	8082                	ret
{
      ...
      84:	fd050513          	addi	a0,a0,-48 # 6050 <malloc+0x11a>
      88:	00006097          	auipc	ra,0x6
      8c:	df2080e7          	jalr	-526(ra) # 5e7a <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	fc050513          	addi	a0,a0,-64 # 6068 <malloc+0x132>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	fc250513          	addi	a0,a0,-62 # 6088 <malloc+0x152>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	f8a50513          	addi	a0,a0,-118 # 6070 <malloc+0x13a>
      ee:	00006097          	auipc	ra,0x6
      f2:	d8c080e7          	jalr	-628(ra) # 5e7a <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	f9650513          	addi	a0,a0,-106 # 6098 <malloc+0x162>
     10a:	00006097          	auipc	ra,0x6
     10e:	d70080e7          	jalr	-656(ra) # 5e7a <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	f9450513          	addi	a0,a0,-108 # 60c0 <malloc+0x18a>
     134:	00006097          	auipc	ra,0x6
     138:	a40080e7          	jalr	-1472(ra) # 5b74 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	f8050513          	addi	a0,a0,-128 # 60c0 <malloc+0x18a>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	f7c58593          	addi	a1,a1,-132 # 60d0 <malloc+0x19a>
     15c:	00006097          	auipc	ra,0x6
     160:	9e8080e7          	jalr	-1560(ra) # 5b44 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	f5850513          	addi	a0,a0,-168 # 60c0 <malloc+0x18a>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	f5c58593          	addi	a1,a1,-164 # 60d8 <malloc+0x1a2>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	f2c50513          	addi	a0,a0,-212 # 60c0 <malloc+0x18a>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	f1650513          	addi	a0,a0,-234 # 60e0 <malloc+0x1aa>
     1d2:	00006097          	auipc	ra,0x6
     1d6:	ca8080e7          	jalr	-856(ra) # 5e7a <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000272 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     290:	e7c50513          	addi	a0,a0,-388 # 6108 <malloc+0x1d2>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     2a8:	e64a8a93          	addi	s5,s5,-412 # 6108 <malloc+0x1d2>
      int cc = write(fd, buf, sz);
     2ac:	0000ca17          	auipc	s4,0xc
     2b0:	df4a0a13          	addi	s4,s4,-524 # c0a0 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2b4:	6b0d                	lui	s6,0x3
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     32a:	df250513          	addi	a0,a0,-526 # 6118 <malloc+0x1e2>
     32e:	00006097          	auipc	ra,0x6
     332:	b4c080e7          	jalr	-1204(ra) # 5e7a <printf>
      exit(1);
     336:	4505                	li	a0,1
     ...
     34c:	df050513          	addi	a0,a0,-528 # 6138 <malloc+0x202>
     350:	00006097          	auipc	ra,0x6
     354:	b2a080e7          	jalr	-1238(ra) # 5e7a <printf>
        exit(1);
     358:	4505                	li	a0,1
...
0000000000000362 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     394:	dc0a8a93          	addi	s5,s5,-576 # 6150 <malloc+0x21a>
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     44c:	d1050513          	addi	a0,a0,-752 # 6158 <malloc+0x222>
     450:	00006097          	auipc	ra,0x6
     454:	a2a080e7          	jalr	-1494(ra) # 5e7a <printf>
      exit(1);
     458:	4505                	li	a0,1
     ...
     46a:	d0a50513          	addi	a0,a0,-758 # 6170 <malloc+0x23a>
     46e:	00006097          	auipc	ra,0x6
     472:	a0c080e7          	jalr	-1524(ra) # 5e7a <printf>
      exit(1);
     476:	4505                	li	a0,1
     ...
     488:	d1c50513          	addi	a0,a0,-740 # 61a0 <malloc+0x26a>
     48c:	00006097          	auipc	ra,0x6
     490:	9ee080e7          	jalr	-1554(ra) # 5e7a <printf>
      exit(1);
     494:	4505                	li	a0,1
     ...
     4a2:	d3250513          	addi	a0,a0,-718 # 61d0 <malloc+0x29a>
     4a6:	00006097          	auipc	ra,0x6
     4aa:	9d4080e7          	jalr	-1580(ra) # 5e7a <printf>
      exit(1);
     4ae:	4505                	li	a0,1
     ...
     4c0:	d2450513          	addi	a0,a0,-732 # 61e0 <malloc+0x2aa>
     4c4:	00006097          	auipc	ra,0x6
     4c8:	9b6080e7          	jalr	-1610(ra) # 5e7a <printf>
      exit(1);
     4cc:	4505                	li	a0,1
...
00000000000004d6 <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     504:	d10b8b93          	addi	s7,s7,-752 # 6210 <malloc+0x2da>
    ...
    n = write(fds[1], "x", 1);
     ...
     514:	bc8c0c13          	addi	s8,s8,-1080 # 60d8 <malloc+0x1a2>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     5bc:	c6050513          	addi	a0,a0,-928 # 6218 <malloc+0x2e2>
     5c0:	00006097          	auipc	ra,0x6
     5c4:	8ba080e7          	jalr	-1862(ra) # 5e7a <printf>
      exit(1);
     5c8:	4505                	li	a0,1
     ...
     5da:	c5a50513          	addi	a0,a0,-934 # 6230 <malloc+0x2fa>
     5de:	00006097          	auipc	ra,0x6
     5e2:	89c080e7          	jalr	-1892(ra) # 5e7a <printf>
      exit(1);
     5e6:	4505                	li	a0,1
     ...
     5f4:	be050513          	addi	a0,a0,-1056 # 61d0 <malloc+0x29a>
     5f8:	00006097          	auipc	ra,0x6
     5fc:	882080e7          	jalr	-1918(ra) # 5e7a <printf>
      exit(1);
     600:	4505                	li	a0,1
     ...
     60e:	c5650513          	addi	a0,a0,-938 # 6260 <malloc+0x32a>
     612:	00006097          	auipc	ra,0x6
     616:	868080e7          	jalr	-1944(ra) # 5e7a <printf>
      exit(1);
     61a:	4505                	li	a0,1
     ...
     62c:	c5050513          	addi	a0,a0,-944 # 6278 <malloc+0x342>
     630:	00006097          	auipc	ra,0x6
     634:	84a080e7          	jalr	-1974(ra) # 5e7a <printf>
      exit(1);
     638:	4505                	li	a0,1
...
0000000000000642 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     682:	a5258593          	addi	a1,a1,-1454 # 60d0 <malloc+0x19a>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     69e:	a2650513          	addi	a0,a0,-1498 # 60c0 <malloc+0x18a>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     6ca:	9fa50513          	addi	a0,a0,-1542 # 60c0 <malloc+0x18a>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6de:	9e650513          	addi	a0,a0,-1562 # 60c0 <malloc+0x18a>
  ...
  write(fd1, "abcdef", 6);
     ...
     71c:	bf058593          	addi	a1,a1,-1040 # 6308 <malloc+0x3d2>
     720:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     75e:	96650513          	addi	a0,a0,-1690 # 60c0 <malloc+0x18a>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     7a2:	b0a50513          	addi	a0,a0,-1270 # 62a8 <malloc+0x372>
     7a6:	00005097          	auipc	ra,0x5
     7aa:	6d4080e7          	jalr	1748(ra) # 5e7a <printf>
    exit(1);
     7ae:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     7be:	b0e50513          	addi	a0,a0,-1266 # 62c8 <malloc+0x392>
     7c2:	00005097          	auipc	ra,0x5
     7c6:	6b8080e7          	jalr	1720(ra) # 5e7a <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7ca:	8652                	mv	a2,s4
     7cc:	85d6                	mv	a1,s5
     7ce:	00006517          	auipc	a0,0x6
     7d2:	b0a50513          	addi	a0,a0,-1270 # 62d8 <malloc+0x3a2>
     7d6:	00005097          	auipc	ra,0x5
     7da:	6a4080e7          	jalr	1700(ra) # 5e7a <printf>
    exit(1);
     7de:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7ee:	b0e50513          	addi	a0,a0,-1266 # 62f8 <malloc+0x3c2>
     7f2:	00005097          	auipc	ra,0x5
     7f6:	688080e7          	jalr	1672(ra) # 5e7a <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7fa:	8652                	mv	a2,s4
     7fc:	85d6                	mv	a1,s5
     7fe:	00006517          	auipc	a0,0x6
     802:	ada50513          	addi	a0,a0,-1318 # 62d8 <malloc+0x3a2>
     806:	00005097          	auipc	ra,0x5
     80a:	674080e7          	jalr	1652(ra) # 5e7a <printf>
    exit(1);
     80e:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     820:	af450513          	addi	a0,a0,-1292 # 6310 <malloc+0x3da>
     824:	00005097          	auipc	ra,0x5
     828:	656080e7          	jalr	1622(ra) # 5e7a <printf>
    exit(1);
     82c:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     83e:	af650513          	addi	a0,a0,-1290 # 6330 <malloc+0x3fa>
     842:	00005097          	auipc	ra,0x5
     846:	638080e7          	jalr	1592(ra) # 5e7a <printf>
    exit(1);
     84a:	4505                	li	a0,1
...
0000000000000854 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     874:	ae050513          	addi	a0,a0,-1312 # 6350 <malloc+0x41a>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     88e:	aeea0a13          	addi	s4,s4,-1298 # 6378 <malloc+0x442>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     892:	00006b17          	auipc	s6,0x6
     896:	b1eb0b13          	addi	s6,s6,-1250 # 63b0 <malloc+0x47a>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     8d8:	a7c50513          	addi	a0,a0,-1412 # 6350 <malloc+0x41a>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8f2:	7b258593          	addi	a1,a1,1970 # c0a0 <buf>
  ...
  if(unlink("small") < 0){
     ...
     914:	a4050513          	addi	a0,a0,-1472 # 6350 <malloc+0x41a>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     940:	a1c50513          	addi	a0,a0,-1508 # 6358 <malloc+0x422>
     944:	00005097          	auipc	ra,0x5
     948:	536080e7          	jalr	1334(ra) # 5e7a <printf>
    exit(1);
     94c:	4505                	li	a0,1
     ...
     95e:	a2e50513          	addi	a0,a0,-1490 # 6388 <malloc+0x452>
     962:	00005097          	auipc	ra,0x5
     966:	518080e7          	jalr	1304(ra) # 5e7a <printf>
      exit(1);
     96a:	4505                	li	a0,1
     ...
     97c:	a4850513          	addi	a0,a0,-1464 # 63c0 <malloc+0x48a>
     980:	00005097          	auipc	ra,0x5
     984:	4fa080e7          	jalr	1274(ra) # 5e7a <printf>
      exit(1);
     988:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     998:	a5450513          	addi	a0,a0,-1452 # 63e8 <malloc+0x4b2>
     99c:	00005097          	auipc	ra,0x5
     9a0:	4de080e7          	jalr	1246(ra) # 5e7a <printf>
    exit(1);
     9a4:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     9b4:	a5850513          	addi	a0,a0,-1448 # 6408 <malloc+0x4d2>
     9b8:	00005097          	auipc	ra,0x5
     9bc:	4c2080e7          	jalr	1218(ra) # 5e7a <printf>
    exit(1);
     9c0:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     9d0:	a5450513          	addi	a0,a0,-1452 # 6420 <malloc+0x4ea>
     9d4:	00005097          	auipc	ra,0x5
     9d8:	4a6080e7          	jalr	1190(ra) # 5e7a <printf>
    exit(1);
     9dc:	4505                	li	a0,1
...
00000000000009e6 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     a04:	a4050513          	addi	a0,a0,-1472 # 6440 <malloc+0x50a>
  ...
  if(fd < 0){
    ...
    ((int*)buf)[0] = i;
     ...
     a1c:	68898993          	addi	s3,s3,1672 # c0a0 <buf>
  ...
  fd = open("big", O_RDONLY);
     ...
     a54:	9f050513          	addi	a0,a0,-1552 # 6440 <malloc+0x50a>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a6c:	63890913          	addi	s2,s2,1592 # c0a0 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a9a:	9b250513          	addi	a0,a0,-1614 # 6448 <malloc+0x512>
     a9e:	00005097          	auipc	ra,0x5
     aa2:	3dc080e7          	jalr	988(ra) # 5e7a <printf>
    exit(1);
     aa6:	4505                	li	a0,1
     ...
     ab8:	9b450513          	addi	a0,a0,-1612 # 6468 <malloc+0x532>
     abc:	00005097          	auipc	ra,0x5
     ac0:	3be080e7          	jalr	958(ra) # 5e7a <printf>
      exit(1);
     ac4:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     ad4:	9c050513          	addi	a0,a0,-1600 # 6490 <malloc+0x55a>
     ad8:	00005097          	auipc	ra,0x5
     adc:	3a2080e7          	jalr	930(ra) # 5e7a <printf>
    exit(1);
     ae0:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     b00:	94450513          	addi	a0,a0,-1724 # 6440 <malloc+0x50a>
     ...
     b2c:	98850513          	addi	a0,a0,-1656 # 64b0 <malloc+0x57a>
     b30:	00005097          	auipc	ra,0x5
     b34:	34a080e7          	jalr	842(ra) # 5e7a <printf>
        exit(1);
     b38:	4505                	li	a0,1
     ...
     b4a:	99250513          	addi	a0,a0,-1646 # 64d8 <malloc+0x5a2>
     b4e:	00005097          	auipc	ra,0x5
     b52:	32c080e7          	jalr	812(ra) # 5e7a <printf>
      exit(1);
     b56:	4505                	li	a0,1
     ...
     b68:	98c50513          	addi	a0,a0,-1652 # 64f0 <malloc+0x5ba>
     b6c:	00005097          	auipc	ra,0x5
     b70:	30e080e7          	jalr	782(ra) # 5e7a <printf>
      exit(1);
     b74:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b84:	99850513          	addi	a0,a0,-1640 # 6518 <malloc+0x5e2>
     b88:	00005097          	auipc	ra,0x5
     b8c:	2f2080e7          	jalr	754(ra) # 5e7a <printf>
    exit(1);
     b90:	4505                	li	a0,1
...
0000000000000b9a <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bb2:	98250513          	addi	a0,a0,-1662 # 6530 <malloc+0x5fa>
  ...
  write(fd, "hello", SZ);
     ...
     bca:	99a58593          	addi	a1,a1,-1638 # 6560 <malloc+0x62a>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     be6:	94e50513          	addi	a0,a0,-1714 # 6530 <malloc+0x5fa>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bfc:	93850513          	addi	a0,a0,-1736 # 6530 <malloc+0x5fa>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     c12:	92250513          	addi	a0,a0,-1758 # 6530 <malloc+0x5fa>
  ...
  write(fd1, "yyy", 3);
     ...
     c26:	98658593          	addi	a1,a1,-1658 # 65a8 <malloc+0x672>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c42:	46258593          	addi	a1,a1,1122 # c0a0 <buf>
     c46:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c8e:	8a650513          	addi	a0,a0,-1882 # 6530 <malloc+0x5fa>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     cae:	89650513          	addi	a0,a0,-1898 # 6540 <malloc+0x60a>
     cb2:	00005097          	auipc	ra,0x5
     cb6:	1c8080e7          	jalr	456(ra) # 5e7a <printf>
    exit(1);
     cba:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     cca:	8a250513          	addi	a0,a0,-1886 # 6568 <malloc+0x632>
     cce:	00005097          	auipc	ra,0x5
     cd2:	1ac080e7          	jalr	428(ra) # 5e7a <printf>
    exit(1);
     cd6:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     ce6:	8a650513          	addi	a0,a0,-1882 # 6588 <malloc+0x652>
     cea:	00005097          	auipc	ra,0x5
     cee:	190080e7          	jalr	400(ra) # 5e7a <printf>
    exit(1);
     cf2:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     d02:	8b250513          	addi	a0,a0,-1870 # 65b0 <malloc+0x67a>
     d06:	00005097          	auipc	ra,0x5
     d0a:	174080e7          	jalr	372(ra) # 5e7a <printf>
    exit(1);
     d0e:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     d1e:	8b650513          	addi	a0,a0,-1866 # 65d0 <malloc+0x69a>
     d22:	00005097          	auipc	ra,0x5
     d26:	158080e7          	jalr	344(ra) # 5e7a <printf>
    exit(1);
     d2a:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     d3a:	8ba50513          	addi	a0,a0,-1862 # 65f0 <malloc+0x6ba>
     d3e:	00005097          	auipc	ra,0x5
     d42:	13c080e7          	jalr	316(ra) # 5e7a <printf>
    exit(1);
     d46:	4505                	li	a0,1
...
0000000000000d50 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d9e:	7c658593          	addi	a1,a1,1990 # 6560 <malloc+0x62a>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     dbe:	85e58593          	addi	a1,a1,-1954 # 6618 <malloc+0x6e2>
     dc2:	00006517          	auipc	a0,0x6
     dc6:	84e50513          	addi	a0,a0,-1970 # 6610 <malloc+0x6da>
  ...
  unlink("lf1");
     ...
     dda:	83a50513          	addi	a0,a0,-1990 # 6610 <malloc+0x6da>
     dde:	00005097          	auipc	ra,0x5
     de2:	d96080e7          	jalr	-618(ra) # 5b74 <unlink>
  if(open("lf1", 0) >= 0){
     de6:	4581                	li	a1,0
     de8:	00006517          	auipc	a0,0x6
     dec:	82850513          	addi	a0,a0,-2008 # 6610 <malloc+0x6da>
  ...
  fd = open("lf2", 0);
     ...
     e02:	81a50513          	addi	a0,a0,-2022 # 6618 <malloc+0x6e2>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     e1a:	28a58593          	addi	a1,a1,650 # c0a0 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     e3a:	7e258593          	addi	a1,a1,2018 # 6618 <malloc+0x6e2>
     e3e:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e50:	7cc50513          	addi	a0,a0,1996 # 6618 <malloc+0x6e2>
     e54:	00005097          	auipc	ra,0x5
     e58:	d20080e7          	jalr	-736(ra) # 5b74 <unlink>
  if(link("lf2", "lf1") >= 0){
     e5c:	00005597          	auipc	a1,0x5
     e60:	7b458593          	addi	a1,a1,1972 # 6610 <malloc+0x6da>
     e64:	00005517          	auipc	a0,0x5
     e68:	7b450513          	addi	a0,a0,1972 # 6618 <malloc+0x6e2>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e7c:	79858593          	addi	a1,a1,1944 # 6610 <malloc+0x6da>
     e80:	00006517          	auipc	a0,0x6
     e84:	8a050513          	addi	a0,a0,-1888 # 6720 <malloc+0x7ea>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     ea6:	77e50513          	addi	a0,a0,1918 # 6620 <malloc+0x6ea>
     eaa:	00005097          	auipc	ra,0x5
     eae:	fd0080e7          	jalr	-48(ra) # 5e7a <printf>
    exit(1);
     eb2:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     ec2:	77a50513          	addi	a0,a0,1914 # 6638 <malloc+0x702>
     ec6:	00005097          	auipc	ra,0x5
     eca:	fb4080e7          	jalr	-76(ra) # 5e7a <printf>
    exit(1);
     ece:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ede:	77650513          	addi	a0,a0,1910 # 6650 <malloc+0x71a>
     ee2:	00005097          	auipc	ra,0x5
     ee6:	f98080e7          	jalr	-104(ra) # 5e7a <printf>
    exit(1);
     eea:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     efa:	77a50513          	addi	a0,a0,1914 # 6670 <malloc+0x73a>
     efe:	00005097          	auipc	ra,0x5
     f02:	f7c080e7          	jalr	-132(ra) # 5e7a <printf>
    exit(1);
     f06:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     f16:	78e50513          	addi	a0,a0,1934 # 66a0 <malloc+0x76a>
     f1a:	00005097          	auipc	ra,0x5
     f1e:	f60080e7          	jalr	-160(ra) # 5e7a <printf>
    exit(1);
     f22:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     f32:	78a50513          	addi	a0,a0,1930 # 66b8 <malloc+0x782>
     f36:	00005097          	auipc	ra,0x5
     f3a:	f44080e7          	jalr	-188(ra) # 5e7a <printf>
    exit(1);
     f3e:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f4e:	78650513          	addi	a0,a0,1926 # 66d0 <malloc+0x79a>
     f52:	00005097          	auipc	ra,0x5
     f56:	f28080e7          	jalr	-216(ra) # 5e7a <printf>
    exit(1);
     f5a:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     f6a:	79250513          	addi	a0,a0,1938 # 66f8 <malloc+0x7c2>
     f6e:	00005097          	auipc	ra,0x5
     f72:	f0c080e7          	jalr	-244(ra) # 5e7a <printf>
    exit(1);
     f76:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f86:	7a650513          	addi	a0,a0,1958 # 6728 <malloc+0x7f2>
     f8a:	00005097          	auipc	ra,0x5
     f8e:	ef0080e7          	jalr	-272(ra) # 5e7a <printf>
    exit(1);
     f92:	4505                	li	a0,1
...
0000000000000f9c <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     ff2:	75aa0a13          	addi	s4,s4,1882 # 6748 <malloc+0x812>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1042:	70a50513          	addi	a0,a0,1802 # 6748 <malloc+0x812>
  ...
  for(i = 0; i < N; i++){
    ...
    10b6:	69e50513          	addi	a0,a0,1694 # 6750 <malloc+0x81a>
    10ba:	00005097          	auipc	ra,0x5
    10be:	dc0080e7          	jalr	-576(ra) # 5e7a <printf>
    exit(1);
    10c2:	4505                	li	a0,1
    ...
    10d6:	69e50513          	addi	a0,a0,1694 # 6770 <malloc+0x83a>
    10da:	00005097          	auipc	ra,0x5
    10de:	da0080e7          	jalr	-608(ra) # 5e7a <printf>
      exit(1);
    10e2:	4505                	li	a0,1
    ...
    10f2:	6a250513          	addi	a0,a0,1698 # 6790 <malloc+0x85a>
    10f6:	00005097          	auipc	ra,0x5
    10fa:	d84080e7          	jalr	-636(ra) # 5e7a <printf>
      exit(1);
    10fe:	4505                	li	a0,1
...
0000000000001108 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1124:	69098993          	addi	s3,s3,1680 # 67b0 <malloc+0x87a>
    1128:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1160:	66450513          	addi	a0,a0,1636 # 67c0 <malloc+0x88a>
    1164:	00005097          	auipc	ra,0x5
    1168:	d16080e7          	jalr	-746(ra) # 5e7a <printf>
      exit(1);
    116c:	4505                	li	a0,1
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    118e:	b5b48493          	addi	s1,s1,-1189 # ffffffffeaeb0b5b <__BSS_END__+0xffffffffeaea1aab>
...
badarg(char *s)
{
    ...
    11ca:	35048493          	addi	s1,s1,848 # c350 <buf+0x2b0>
  for(int i = 0; i < 50000; i++){
    ...
    11dc:	e9098993          	addi	s3,s3,-368 # 6068 <malloc+0x132>
    argv[0] = (char*)0xffffffff;
...
0000000000001202 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1264:	75878793          	addi	a5,a5,1880 # 79b8 <malloc+0x1a82>
  ...
  if(pid == 0){
    ...
    129a:	6f278793          	addi	a5,a5,1778 # 8988 <big.0>
    129e:	00008697          	auipc	a3,0x8
    12a2:	6ea68693          	addi	a3,a3,1770 # 9988 <__global_pointer$+0x90f>
      big[i] = 'x';
    ...
    12b8:	6c078a23          	sb	zero,1748(a5) # 9988 <__global_pointer$+0x90f>
    char *args2[] = { big, big, big, 0 };
    12bc:	00007797          	auipc	a5,0x7
    12c0:	14478793          	addi	a5,a5,324 # 8400 <malloc+0x24ca>
    ...
    12e4:	d8850513          	addi	a0,a0,-632 # 6068 <malloc+0x132>
    ...
    12fc:	57050513          	addi	a0,a0,1392 # 6868 <malloc+0x932>
    1300:	00005097          	auipc	ra,0x5
    1304:	b7a080e7          	jalr	-1158(ra) # 5e7a <printf>
      exit(1);
    1308:	4505                	li	a0,1
    ...
    131c:	4c850513          	addi	a0,a0,1224 # 67e0 <malloc+0x8aa>
    1320:	00005097          	auipc	ra,0x5
    1324:	b5a080e7          	jalr	-1190(ra) # 5e7a <printf>
    exit(1);
    1328:	4505                	li	a0,1
    ...
    133c:	4c850513          	addi	a0,a0,1224 # 6800 <malloc+0x8ca>
    1340:	00005097          	auipc	ra,0x5
    1344:	b3a080e7          	jalr	-1222(ra) # 5e7a <printf>
    exit(1);
    1348:	4505                	li	a0,1
    ...
    135e:	4c650513          	addi	a0,a0,1222 # 6820 <malloc+0x8ea>
    1362:	00005097          	auipc	ra,0x5
    1366:	b18080e7          	jalr	-1256(ra) # 5e7a <printf>
    exit(1);
    136a:	4505                	li	a0,1
    ...
    137e:	4ce50513          	addi	a0,a0,1230 # 6848 <malloc+0x912>
    1382:	00005097          	auipc	ra,0x5
    1386:	af8080e7          	jalr	-1288(ra) # 5e7a <printf>
    exit(1);
    138a:	4505                	li	a0,1
    ...
    1398:	94c50513          	addi	a0,a0,-1716 # 6ce0 <malloc+0xdaa>
    139c:	00005097          	auipc	ra,0x5
    13a0:	ade080e7          	jalr	-1314(ra) # 5e7a <printf>
    exit(1);
    13a4:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    13e2:	4b250513          	addi	a0,a0,1202 # 6890 <malloc+0x95a>
    13e6:	00005097          	auipc	ra,0x5
    13ea:	a94080e7          	jalr	-1388(ra) # 5e7a <printf>
    exit(1);
    13ee:	4505                	li	a0,1
...
00000000000013f8 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    140c:	cb850513          	addi	a0,a0,-840 # 60c0 <malloc+0x18a>
  ...
  if(pid == 0){
    ...
    1448:	c7c98993          	addi	s3,s3,-900 # 60c0 <malloc+0x18a>
      int n = write(fd, "1234567890", 10);
    144c:	4a29                	li	s4,10
    144e:	00005b97          	auipc	s7,0x5
    1452:	4a2b8b93          	addi	s7,s7,1186 # 68f0 <malloc+0x9ba>
    ...
    14d4:	3f050513          	addi	a0,a0,1008 # 68c0 <malloc+0x98a>
    14d8:	00005097          	auipc	ra,0x5
    14dc:	9a2080e7          	jalr	-1630(ra) # 5e7a <printf>
    exit(1);
    14e0:	4505                	li	a0,1
    ...
    14f0:	3ec50513          	addi	a0,a0,1004 # 68d8 <malloc+0x9a2>
    14f4:	00005097          	auipc	ra,0x5
    14f8:	986080e7          	jalr	-1658(ra) # 5e7a <printf>
        exit(1);
    14fc:	4505                	li	a0,1
    ...
    150e:	3f650513          	addi	a0,a0,1014 # 6900 <malloc+0x9ca>
    1512:	00005097          	auipc	ra,0x5
    1516:	968080e7          	jalr	-1688(ra) # 5e7a <printf>
        exit(1);
    151a:	4505                	li	a0,1
    ...
    153c:	b88a0a13          	addi	s4,s4,-1144 # 60c0 <malloc+0x18a>
    int n = write(fd, "xxx", 3);
    1540:	498d                	li	s3,3
    1542:	00005b97          	auipc	s7,0x5
    1546:	3deb8b93          	addi	s7,s7,990 # 6920 <malloc+0x9ea>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
    154a:	85da                	mv	a1,s6
    154c:	8552                	mv	a0,s4
  ...
  unlink("truncfile");
    ...
    1590:	b3450513          	addi	a0,a0,-1228 # 60c0 <malloc+0x18a>
  ...
  exit(xstatus);
    ...
    15b2:	32a50513          	addi	a0,a0,810 # 68d8 <malloc+0x9a2>
    15b6:	00005097          	auipc	ra,0x5
    15ba:	8c4080e7          	jalr	-1852(ra) # 5e7a <printf>
      exit(1);
    15be:	4505                	li	a0,1
    ...
    15d4:	35850513          	addi	a0,a0,856 # 6928 <malloc+0x9f2>
    15d8:	00005097          	auipc	ra,0x5
    15dc:	8a2080e7          	jalr	-1886(ra) # 5e7a <printf>
      exit(1);
    15e0:	4505                	li	a0,1
...
00000000000015ea <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    15fa:	a7278793          	addi	a5,a5,-1422 # 6068 <malloc+0x132>
    15fe:	fcf43023          	sd	a5,-64(s0)
    1602:	00005797          	auipc	a5,0x5
    1606:	34678793          	addi	a5,a5,838 # 6948 <malloc+0xa12>
    160a:	fcf43423          	sd	a5,-56(s0)
    160e:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1612:	00005517          	auipc	a0,0x5
    1616:	33e50513          	addi	a0,a0,830 # 6950 <malloc+0xa1a>
  ...
  if(pid == 0) {
    ...
    1646:	30e50513          	addi	a0,a0,782 # 6950 <malloc+0xa1a>
    ...
    1662:	31250513          	addi	a0,a0,786 # 6970 <malloc+0xa3a>
    1666:	00005097          	auipc	ra,0x5
    166a:	814080e7          	jalr	-2028(ra) # 5e7a <printf>
      exit(1);
    166e:	4505                	li	a0,1
    ...
    1680:	24450513          	addi	a0,a0,580 # 68c0 <malloc+0x98a>
    1684:	00004097          	auipc	ra,0x4
    1688:	7f6080e7          	jalr	2038(ra) # 5e7a <printf>
     exit(1);
    168c:	4505                	li	a0,1
    ...
    169c:	2c050513          	addi	a0,a0,704 # 6958 <malloc+0xa22>
    16a0:	00004097          	auipc	ra,0x4
    16a4:	7da080e7          	jalr	2010(ra) # 5e7a <printf>
      exit(1);
    16a8:	4505                	li	a0,1
    ...
    16ba:	9b250513          	addi	a0,a0,-1614 # 6068 <malloc+0x132>
  ...
  if(xstatus != 0)
    ...
    16ee:	29650513          	addi	a0,a0,662 # 6980 <malloc+0xa4a>
    16f2:	00004097          	auipc	ra,0x4
    16f6:	788080e7          	jalr	1928(ra) # 5e7a <printf>
      exit(1);
    16fa:	4505                	li	a0,1
    ...
    170a:	29250513          	addi	a0,a0,658 # 6998 <malloc+0xa62>
    170e:	00004097          	auipc	ra,0x4
    1712:	76c080e7          	jalr	1900(ra) # 5e7a <printf>
    1716:	b7d1                	j	16da <exectest+0xf0>
  fd = open("echo-ok", O_RDONLY);
    1718:	4581                	li	a1,0
    171a:	00005517          	auipc	a0,0x5
    171e:	23650513          	addi	a0,a0,566 # 6950 <malloc+0xa1a>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    1748:	cc450513          	addi	a0,a0,-828 # 6408 <malloc+0x4d2>
    174c:	00004097          	auipc	ra,0x4
    1750:	72e080e7          	jalr	1838(ra) # 5e7a <printf>
    exit(1);
    1754:	4505                	li	a0,1
    ...
    1764:	17850513          	addi	a0,a0,376 # 68d8 <malloc+0x9a2>
    1768:	00004097          	auipc	ra,0x4
    176c:	712080e7          	jalr	1810(ra) # 5e7a <printf>
    exit(1);
    1770:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    177e:	1d650513          	addi	a0,a0,470 # 6950 <malloc+0xa1a>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    17a8:	20c50513          	addi	a0,a0,524 # 69b0 <malloc+0xa7a>
    17ac:	00004097          	auipc	ra,0x4
    17b0:	6ce080e7          	jalr	1742(ra) # 5e7a <printf>
    exit(1);
    17b4:	4505                	li	a0,1
...
00000000000017c8 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    1810:	894a8a93          	addi	s5,s5,-1900 # c0a0 <buf>
    1814:	864e                	mv	a2,s3
    1816:	85d6                	mv	a1,s5
    ...
    182c:	87870713          	addi	a4,a4,-1928 # c0a0 <buf>
    ...
    186e:	15e50513          	addi	a0,a0,350 # 69c8 <malloc+0xa92>
    1872:	00004097          	auipc	ra,0x4
    1876:	608080e7          	jalr	1544(ra) # 5e7a <printf>
    exit(1);
    187a:	4505                	li	a0,1
    ...
    189e:	806b8b93          	addi	s7,s7,-2042 # c0a0 <buf>
    ...
    18b6:	42db0b13          	addi	s6,s6,1069 # 142d <truncate3+0x35>
{
    ...
    18fc:	0e850513          	addi	a0,a0,232 # 69e0 <malloc+0xaaa>
    1900:	00004097          	auipc	ra,0x4
    1904:	57a080e7          	jalr	1402(ra) # 5e7a <printf>
        exit(1);
    1908:	4505                	li	a0,1
    ...
    1918:	0e450513          	addi	a0,a0,228 # 69f8 <malloc+0xac2>
    191c:	00004097          	auipc	ra,0x4
    1920:	55e080e7          	jalr	1374(ra) # 5e7a <printf>
          return;
    ...
    194c:	0c850513          	addi	a0,a0,200 # 6a10 <malloc+0xada>
    1950:	00004097          	auipc	ra,0x4
    1954:	52a080e7          	jalr	1322(ra) # 5e7a <printf>
      exit(1);
    1958:	4505                	li	a0,1
    ...
    199c:	09850513          	addi	a0,a0,152 # 6a30 <malloc+0xafa>
    19a0:	00004097          	auipc	ra,0x4
    19a4:	4da080e7          	jalr	1242(ra) # 5e7a <printf>
    exit(1);
    19a8:	4505                	li	a0,1
...
00000000000019b2 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1a14:	eb050513          	addi	a0,a0,-336 # 68c0 <malloc+0x98a>
    1a18:	00004097          	auipc	ra,0x4
    1a1c:	462080e7          	jalr	1122(ra) # 5e7a <printf>
      exit(1);
    1a20:	4505                	li	a0,1
    ...
    1a30:	01c50513          	addi	a0,a0,28 # 6a48 <malloc+0xb12>
    1a34:	00004097          	auipc	ra,0x4
    1a38:	446080e7          	jalr	1094(ra) # 5e7a <printf>
        exit(1);
    1a3c:	4505                	li	a0,1
    ...
    1a4c:	01850513          	addi	a0,a0,24 # 6a60 <malloc+0xb2a>
    1a50:	00004097          	auipc	ra,0x4
    1a54:	42a080e7          	jalr	1066(ra) # 5e7a <printf>
        exit(1);
    1a58:	4505                	li	a0,1
...
0000000000001a6c <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1ac4:	e0050513          	addi	a0,a0,-512 # 68c0 <malloc+0x98a>
    1ac8:	00004097          	auipc	ra,0x4
    1acc:	3b2080e7          	jalr	946(ra) # 5e7a <printf>
      exit(1);
    1ad0:	4505                	li	a0,1
    ...
    1ae8:	ddc50513          	addi	a0,a0,-548 # 68c0 <malloc+0x98a>
    1aec:	00004097          	auipc	ra,0x4
    1af0:	38e080e7          	jalr	910(ra) # 5e7a <printf>
        exit(1);
    1af4:	4505                	li	a0,1
...
0000000000001b06 <forkfork>:
{
    ...
    1b62:	f2250513          	addi	a0,a0,-222 # 6a80 <malloc+0xb4a>
    1b66:	00004097          	auipc	ra,0x4
    1b6a:	314080e7          	jalr	788(ra) # 5e7a <printf>
      exit(1);
    1b6e:	4505                	li	a0,1
    ...
    1b74:	fb4080e7          	jalr	-76(ra) # 5b24 <exit>
{
    ...
    1bba:	eda50513          	addi	a0,a0,-294 # 6a90 <malloc+0xb5a>
    1bbe:	00004097          	auipc	ra,0x4
    1bc2:	2bc080e7          	jalr	700(ra) # 5e7a <printf>
      exit(1);
    1bc6:	4505                	li	a0,1
...
0000000000001bd0 <reparent2>:
{
  ...
  exit(0);
    ...
    1c08:	0dc50513          	addi	a0,a0,220 # 6ce0 <malloc+0xdaa>
    1c0c:	00004097          	auipc	ra,0x4
    1c10:	26e080e7          	jalr	622(ra) # 5e7a <printf>
      exit(1);
    1c14:	4505                	li	a0,1
...
0000000000001c38 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1caa:	03a50513          	addi	a0,a0,58 # 6ce0 <malloc+0xdaa>
    1cae:	00004097          	auipc	ra,0x4
    1cb2:	1cc080e7          	jalr	460(ra) # 5e7a <printf>
      exit(1);
    1cb6:	4505                	li	a0,1
    ...
    1cde:	c7e50513          	addi	a0,a0,-898 # 6958 <malloc+0xa22>
    1ce2:	00004097          	auipc	ra,0x4
    1ce6:	198080e7          	jalr	408(ra) # 5e7a <printf>
          exit(1);
    1cea:	4505                	li	a0,1
    ...
    1d56:	d5e50513          	addi	a0,a0,-674 # 6ab0 <malloc+0xb7a>
    1d5a:	00004097          	auipc	ra,0x4
    1d5e:	120080e7          	jalr	288(ra) # 5e7a <printf>
            exit(1);
    1d62:	4505                	li	a0,1
    ...
    1d80:	d4c50513          	addi	a0,a0,-692 # 6ac8 <malloc+0xb92>
    1d84:	00004097          	auipc	ra,0x4
    1d88:	0f6080e7          	jalr	246(ra) # 5e7a <printf>
        exit(1);
    1d8c:	4505                	li	a0,1
    ...
    1de0:	d1450513          	addi	a0,a0,-748 # 6af0 <malloc+0xbba>
    1de4:	00004097          	auipc	ra,0x4
    1de8:	096080e7          	jalr	150(ra) # 5e7a <printf>
        exit(1);
    1dec:	4505                	li	a0,1
...
0000000000001e64 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1e86:	25650513          	addi	a0,a0,598 # 60d8 <malloc+0x1a2>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1eb0:	e6da8a9b          	addiw	s5,s5,-403 # 41c64e6d <__BSS_END__+0x41c55dbd>
    1eb4:	6a0d                	lui	s4,0x3
    1eb6:	039a0a1b          	addiw	s4,s4,57 # 3039 <fourteen+0x129>
    if((x % 3) == 0){
    1eba:	000ab9b7          	lui	s3,0xab
    1ebe:	aab98993          	addi	s3,s3,-1365 # aaaab <__BSS_END__+0x9b9fb>
    ...
    1ece:	20eb0b13          	addi	s6,s6,526 # 60d8 <malloc+0x1a2>
      link("cat", "x");
    1ed2:	00005c97          	auipc	s9,0x5
    1ed6:	c46c8c93          	addi	s9,s9,-954 # 6b18 <malloc+0xbe2>
    ...
    1ee6:	9de50513          	addi	a0,a0,-1570 # 68c0 <malloc+0x98a>
    1eea:	00004097          	auipc	ra,0x4
    1eee:	f90080e7          	jalr	-112(ra) # 5e7a <printf>
    exit(1);
    1ef2:	4505                	li	a0,1
...
0000000000001f86 <manywrites>:
{
  ...
  exit(0);
    ...
    1ff8:	cec50513          	addi	a0,a0,-788 # 6ce0 <malloc+0xdaa>
    1ffc:	00004097          	auipc	ra,0x4
    2000:	e7e080e7          	jalr	-386(ra) # 5e7a <printf>
      exit(1);
    2004:	4505                	li	a0,1
    ...
    204a:	05ac8c93          	addi	s9,s9,90 # c0a0 <buf>
    ...
    20b4:	a7050513          	addi	a0,a0,-1424 # 6b20 <malloc+0xbea>
    20b8:	00004097          	auipc	ra,0x4
    20bc:	dc2080e7          	jalr	-574(ra) # 5e7a <printf>
            exit(1);
    20c0:	4505                	li	a0,1
    ...
    20d4:	06850513          	addi	a0,a0,104 # 6138 <malloc+0x202>
    20d8:	00004097          	auipc	ra,0x4
    20dc:	da2080e7          	jalr	-606(ra) # 5e7a <printf>
            exit(1);
    20e0:	4505                	li	a0,1
...
00000000000020fe <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    212e:	a5650513          	addi	a0,a0,-1450 # 6b80 <malloc+0xc4a>
    2132:	00004097          	auipc	ra,0x4
    2136:	d48080e7          	jalr	-696(ra) # 5e7a <printf>
    exit(1);
    213a:	4505                	li	a0,1
    ...
    2152:	9ea50513          	addi	a0,a0,-1558 # 6b38 <malloc+0xc02>
    2156:	00004097          	auipc	ra,0x4
    215a:	d24080e7          	jalr	-732(ra) # 5e7a <printf>
    exit(1);
    215e:	4505                	li	a0,1
    ...
    216e:	9e650513          	addi	a0,a0,-1562 # 6b50 <malloc+0xc1a>
    2172:	00004097          	auipc	ra,0x4
    2176:	d08080e7          	jalr	-760(ra) # 5e7a <printf>
      exit(1);
    217a:	4505                	li	a0,1
    ...
    218a:	9e250513          	addi	a0,a0,-1566 # 6b68 <malloc+0xc32>
    218e:	00004097          	auipc	ra,0x4
    2192:	cec080e7          	jalr	-788(ra) # 5e7a <printf>
    exit(1);
    2196:	4505                	li	a0,1
...
00000000000021d4 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21f6:	35098993          	addi	s3,s3,848 # c350 <buf+0x2b0>
    21fa:	1003d937          	lui	s2,0x1003d
    21fe:	090e                	slli	s2,s2,0x3
    2200:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002e3d0>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2244:	68050513          	addi	a0,a0,1664 # 68c0 <malloc+0x98a>
    2248:	00004097          	auipc	ra,0x4
    224c:	c32080e7          	jalr	-974(ra) # 5e7a <printf>
      exit(1);
    2250:	4505                	li	a0,1
    ...
    2266:	94650513          	addi	a0,a0,-1722 # 6ba8 <malloc+0xc72>
    226a:	00004097          	auipc	ra,0x4
    226e:	c10080e7          	jalr	-1008(ra) # 5e7a <printf>
      exit(1);
    2272:	4505                	li	a0,1
...
0000000000002286 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    22ee:	5d650513          	addi	a0,a0,1494 # 68c0 <malloc+0x98a>
    22f2:	00004097          	auipc	ra,0x4
    22f6:	b88080e7          	jalr	-1144(ra) # 5e7a <printf>
      exit(1);
    22fa:	4505                	li	a0,1
    ...
    231a:	8b250513          	addi	a0,a0,-1870 # 6bc8 <malloc+0xc92>
    231e:	00004097          	auipc	ra,0x4
    2322:	b5c080e7          	jalr	-1188(ra) # 5e7a <printf>
      exit(1);
    2326:	4505                	li	a0,1
...
000000000000233a <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    234a:	89a50513          	addi	a0,a0,-1894 # 6be0 <malloc+0xcaa>
  ...
  fd = open("bigarg-ok", 0);
    ...
    237c:	86850513          	addi	a0,a0,-1944 # 6be0 <malloc+0xcaa>
  ...
  close(fd);
    ...
    23a2:	4ea78793          	addi	a5,a5,1258 # 8888 <args.1>
    23a6:	00006697          	auipc	a3,0x6
    23aa:	5da68693          	addi	a3,a3,1498 # 8980 <args.1+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    23ae:	00005717          	auipc	a4,0x5
    23b2:	84270713          	addi	a4,a4,-1982 # 6bf0 <malloc+0xcba>
    ...
    2406:	8ce50513          	addi	a0,a0,-1842 # 6cd0 <malloc+0xd9a>
    240a:	00004097          	auipc	ra,0x4
    240e:	a70080e7          	jalr	-1424(ra) # 5e7a <printf>
    exit(1);
    2412:	4505                	li	a0,1
    ...
    242a:	8ca50513          	addi	a0,a0,-1846 # 6cf0 <malloc+0xdba>
    242e:	00004097          	auipc	ra,0x4
    2432:	a4c080e7          	jalr	-1460(ra) # 5e7a <printf>
    exit(1);
    2436:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    247e:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <__BSS_END__+0xfffffffffffeff50>
    2482:	85a6                	mv	a1,s1
    2484:	00005517          	auipc	a0,0x5
    2488:	88c50513          	addi	a0,a0,-1908 # 6d10 <malloc+0xdda>
    248c:	00004097          	auipc	ra,0x4
    2490:	9ee080e7          	jalr	-1554(ra) # 5e7a <printf>
    exit(1);
    2494:	4505                	li	a0,1
    ...
    24a4:	42050513          	addi	a0,a0,1056 # 68c0 <malloc+0x98a>
    24a8:	00004097          	auipc	ra,0x4
    24ac:	9d2080e7          	jalr	-1582(ra) # 5e7a <printf>
    exit(1);
    24b0:	4505                	li	a0,1
...
00000000000024c4 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    253e:	47e78793          	addi	a5,a5,1150 # 79b8 <malloc+0x1a82>
  ...
  if(ret != -1){
    ...
    2582:	7ba50513          	addi	a0,a0,1978 # 6d38 <malloc+0xe02>
    2586:	00004097          	auipc	ra,0x4
    258a:	8f4080e7          	jalr	-1804(ra) # 5e7a <printf>
    exit(1);
    258e:	4505                	li	a0,1
    ...
    25a0:	24450513          	addi	a0,a0,580 # 67e0 <malloc+0x8aa>
    25a4:	00004097          	auipc	ra,0x4
    25a8:	8d6080e7          	jalr	-1834(ra) # 5e7a <printf>
    exit(1);
    25ac:	4505                	li	a0,1
    ...
    25be:	24650513          	addi	a0,a0,582 # 6800 <malloc+0x8ca>
    25c2:	00004097          	auipc	ra,0x4
    25c6:	8b8080e7          	jalr	-1864(ra) # 5e7a <printf>
    exit(1);
    25ca:	4505                	li	a0,1
    ...
    25de:	24650513          	addi	a0,a0,582 # 6820 <malloc+0x8ea>
    25e2:	00004097          	auipc	ra,0x4
    25e6:	898080e7          	jalr	-1896(ra) # 5e7a <printf>
    exit(1);
    25ea:	4505                	li	a0,1
    ...
    25fc:	25050513          	addi	a0,a0,592 # 6848 <malloc+0x912>
    2600:	00004097          	auipc	ra,0x4
    2604:	87a080e7          	jalr	-1926(ra) # 5e7a <printf>
    exit(1);
    2608:	4505                	li	a0,1
...
0000000000002612 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2648:	73450513          	addi	a0,a0,1844 # 6d78 <malloc+0xe42>
  ...
  if(n >= 0){
    ...
    2678:	72450513          	addi	a0,a0,1828 # 6d98 <malloc+0xe62>
    267c:	00003097          	auipc	ra,0x3
    2680:	7fe080e7          	jalr	2046(ra) # 5e7a <printf>
    exit(1);
    2684:	4505                	li	a0,1
    ...
    2696:	6ae50513          	addi	a0,a0,1710 # 6d40 <malloc+0xe0a>
    269a:	00003097          	auipc	ra,0x3
    269e:	7e0080e7          	jalr	2016(ra) # 5e7a <printf>
    exit(1);
    26a2:	4505                	li	a0,1
    ...
    26b2:	6aa50513          	addi	a0,a0,1706 # 6d58 <malloc+0xe22>
    26b6:	00003097          	auipc	ra,0x3
    26ba:	7c4080e7          	jalr	1988(ra) # 5e7a <printf>
    exit(1);
    26be:	4505                	li	a0,1
    ...
    26cc:	6b850513          	addi	a0,a0,1720 # 6d80 <malloc+0xe4a>
    26d0:	00003097          	auipc	ra,0x3
    26d4:	7aa080e7          	jalr	1962(ra) # 5e7a <printf>
    exit(1);
    26d8:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    26f0:	68c50513          	addi	a0,a0,1676 # 6d78 <malloc+0xe42>
    26f4:	00003097          	auipc	ra,0x3
    26f8:	480080e7          	jalr	1152(ra) # 5b74 <unlink>
  fd = open("README", O_RDONLY);
    26fc:	4581                	li	a1,0
    26fe:	00004517          	auipc	a0,0x4
    2702:	b1250513          	addi	a0,a0,-1262 # 6210 <malloc+0x2da>
  ...
  if(n >= 0){
    ...
    272c:	6a050513          	addi	a0,a0,1696 # 6dc8 <malloc+0xe92>
    2730:	00003097          	auipc	ra,0x3
    2734:	74a080e7          	jalr	1866(ra) # 5e7a <printf>
    exit(1);
    2738:	4505                	li	a0,1
    ...
    2746:	63e50513          	addi	a0,a0,1598 # 6d80 <malloc+0xe4a>
    274a:	00003097          	auipc	ra,0x3
    274e:	730080e7          	jalr	1840(ra) # 5e7a <printf>
    exit(1);
    2752:	4505                	li	a0,1
...
0000000000002770 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    27ae:	6705                	lui	a4,0x1
      *b = 99;
    27b0:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff0f50>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    27d0:	62450513          	addi	a0,a0,1572 # 6df0 <malloc+0xeba>
    27d4:	00003097          	auipc	ra,0x3
    27d8:	6a6080e7          	jalr	1702(ra) # 5e7a <printf>
    exit(1);
    27dc:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    283c:	5d850513          	addi	a0,a0,1496 # 6e10 <malloc+0xeda>
    2840:	00003097          	auipc	ra,0x3
    2844:	63a080e7          	jalr	1594(ra) # 5e7a <printf>
    exit(1);
    2848:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    289e:	5d650513          	addi	a0,a0,1494 # 6e70 <malloc+0xf3a>
    28a2:	00003097          	auipc	ra,0x3
    28a6:	5d8080e7          	jalr	1496(ra) # 5e7a <printf>
    exit(1);
    28aa:	4505                	li	a0,1
    ...
    28c0:	57450513          	addi	a0,a0,1396 # 6e30 <malloc+0xefa>
    28c4:	00003097          	auipc	ra,0x3
    28c8:	5b6080e7          	jalr	1462(ra) # 5e7a <printf>
      exit(1);
    28cc:	4505                	li	a0,1
    ...
    28dc:	57850513          	addi	a0,a0,1400 # 6e50 <malloc+0xf1a>
    28e0:	00003097          	auipc	ra,0x3
    28e4:	59a080e7          	jalr	1434(ra) # 5e7a <printf>
    exit(1);
    28e8:	4505                	li	a0,1
...
0000000000002918 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    297a:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f0f4f>
  a = sbrk(0);
    297e:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    29de:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f0f4f>
  ...
  if(c != a){
    ...
    2a26:	46e50513          	addi	a0,a0,1134 # 6e90 <malloc+0xf5a>
    2a2a:	00003097          	auipc	ra,0x3
    2a2e:	450080e7          	jalr	1104(ra) # 5e7a <printf>
    exit(1);
    2a32:	4505                	li	a0,1
    ...
    2a42:	49a50513          	addi	a0,a0,1178 # 6ed8 <malloc+0xfa2>
    2a46:	00003097          	auipc	ra,0x3
    2a4a:	434080e7          	jalr	1076(ra) # 5e7a <printf>
    exit(1);
    2a4e:	4505                	li	a0,1
    ...
    2a62:	49a50513          	addi	a0,a0,1178 # 6ef8 <malloc+0xfc2>
    2a66:	00003097          	auipc	ra,0x3
    2a6a:	414080e7          	jalr	1044(ra) # 5e7a <printf>
    exit(1);
    2a6e:	4505                	li	a0,1
    ...
    2a82:	4ba50513          	addi	a0,a0,1210 # 6f38 <malloc+0x1002>
    2a86:	00003097          	auipc	ra,0x3
    2a8a:	3f4080e7          	jalr	1012(ra) # 5e7a <printf>
    exit(1);
    2a8e:	4505                	li	a0,1
    ...
    2a9e:	4ce50513          	addi	a0,a0,1230 # 6f68 <malloc+0x1032>
    2aa2:	00003097          	auipc	ra,0x3
    2aa6:	3d8080e7          	jalr	984(ra) # 5e7a <printf>
    exit(1);
    2aaa:	4505                	li	a0,1
    ...
    2abe:	4e650513          	addi	a0,a0,1254 # 6fa0 <malloc+0x106a>
    2ac2:	00003097          	auipc	ra,0x3
    2ac6:	3b8080e7          	jalr	952(ra) # 5e7a <printf>
    exit(1);
    2aca:	4505                	li	a0,1
...
0000000000002ad4 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2af8:	4d450513          	addi	a0,a0,1236 # 6fc8 <malloc+0x1092>
    2afc:	00003097          	auipc	ra,0x3
    2b00:	068080e7          	jalr	104(ra) # 5b64 <open>
    2b04:	84aa                	mv	s1,a0
  unlink("sbrk");
    2b06:	00004517          	auipc	a0,0x4
    2b0a:	4c250513          	addi	a0,a0,1218 # 6fc8 <malloc+0x1092>
  ...
  if(pipe((int *) a) != 0){
    ...
    2b5e:	47650513          	addi	a0,a0,1142 # 6fd0 <malloc+0x109a>
    2b62:	00003097          	auipc	ra,0x3
    2b66:	318080e7          	jalr	792(ra) # 5e7a <printf>
    exit(1);
    2b6a:	4505                	li	a0,1
    ...
    2b7a:	47250513          	addi	a0,a0,1138 # 6fe8 <malloc+0x10b2>
    2b7e:	00003097          	auipc	ra,0x3
    2b82:	2fc080e7          	jalr	764(ra) # 5e7a <printf>
    exit(1);
    2b86:	4505                	li	a0,1
    ...
    2b96:	e3650513          	addi	a0,a0,-458 # 69c8 <malloc+0xa92>
    2b9a:	00003097          	auipc	ra,0x3
    2b9e:	2e0080e7          	jalr	736(ra) # 5e7a <printf>
    exit(1);
    2ba2:	4505                	li	a0,1
...
0000000000002bac <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2bc0:	44450513          	addi	a0,a0,1092 # 7000 <malloc+0x10ca>
  ...
  close(fd);
    ...
    2c08:	cd450513          	addi	a0,a0,-812 # 68d8 <malloc+0x9a2>
    2c0c:	00003097          	auipc	ra,0x3
    2c10:	26e080e7          	jalr	622(ra) # 5e7a <printf>
    exit(1);
    2c14:	4505                	li	a0,1
...
0000000000002c1e <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2c56:	08e50513          	addi	a0,a0,142 # 6ce0 <malloc+0xdaa>
    2c5a:	00003097          	auipc	ra,0x3
    2c5e:	220080e7          	jalr	544(ra) # 5e7a <printf>
    exit(1);
    2c62:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2cac:	03850513          	addi	a0,a0,56 # 6ce0 <malloc+0xdaa>
    2cb0:	00003097          	auipc	ra,0x3
    2cb4:	1ca080e7          	jalr	458(ra) # 5e7a <printf>
    exit(1);
    2cb8:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2ce4:	8007879b          	addiw	a5,a5,-2048 # a800 <uninit+0xe70>
    ...
    2d0c:	fd850513          	addi	a0,a0,-40 # 6ce0 <malloc+0xdaa>
    2d10:	00003097          	auipc	ra,0x3
    2d14:	16a080e7          	jalr	362(ra) # 5e7a <printf>
    exit(1);
    2d18:	4505                	li	a0,1
...
0000000000002e0a <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    2e16:	0511                	addi	a0,a0,4 # ffffffff80000004 <__BSS_END__+0xffffffff7fff0f54>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2e88:	e5c50513          	addi	a0,a0,-420 # 6ce0 <malloc+0xdaa>
    2e8c:	00003097          	auipc	ra,0x3
    2e90:	fee080e7          	jalr	-18(ra) # 5e7a <printf>
      exit(1);
    2e94:	4505                	li	a0,1
    ...
    2ee2:	18a50513          	addi	a0,a0,394 # 6068 <malloc+0x132>
    2ee6:	faa43423          	sd	a0,-88(s0)
    2eea:	00003797          	auipc	a5,0x3
    2eee:	1ee78793          	addi	a5,a5,494 # 60d8 <malloc+0x1a2>
...
0000000000002f10 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2f20:	2bc50513          	addi	a0,a0,700 # 71d8 <malloc+0x12a2>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2f32:	10250513          	addi	a0,a0,258 # 7030 <malloc+0x10fa>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2f48:	14450513          	addi	a0,a0,324 # 7088 <malloc+0x1152>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2f66:	19e50513          	addi	a0,a0,414 # 7100 <malloc+0x11ca>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2f82:	1f250513          	addi	a0,a0,498 # 7170 <malloc+0x123a>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2f94:	23850513          	addi	a0,a0,568 # 71c8 <malloc+0x1292>
  ...
  unlink("12345678901234");
    ...
    3012:	ffa50513          	addi	a0,a0,-6 # 7008 <malloc+0x10d2>
    3016:	00003097          	auipc	ra,0x3
    301a:	e64080e7          	jalr	-412(ra) # 5e7a <printf>
    exit(1);
    301e:	4505                	li	a0,1
    ...
    302e:	02650513          	addi	a0,a0,38 # 7050 <malloc+0x111a>
    3032:	00003097          	auipc	ra,0x3
    3036:	e48080e7          	jalr	-440(ra) # 5e7a <printf>
    exit(1);
    303a:	4505                	li	a0,1
    ...
    304a:	07250513          	addi	a0,a0,114 # 70b8 <malloc+0x1182>
    304e:	00003097          	auipc	ra,0x3
    3052:	e2c080e7          	jalr	-468(ra) # 5e7a <printf>
    exit(1);
    3056:	4505                	li	a0,1
    ...
    3066:	0ce50513          	addi	a0,a0,206 # 7130 <malloc+0x11fa>
    306a:	00003097          	auipc	ra,0x3
    306e:	e10080e7          	jalr	-496(ra) # 5e7a <printf>
    exit(1);
    3072:	4505                	li	a0,1
    ...
    3082:	11250513          	addi	a0,a0,274 # 7190 <malloc+0x125a>
    3086:	00003097          	auipc	ra,0x3
    308a:	df4080e7          	jalr	-524(ra) # 5e7a <printf>
    exit(1);
    308e:	4505                	li	a0,1
    ...
    309e:	14e50513          	addi	a0,a0,334 # 71e8 <malloc+0x12b2>
    30a2:	00003097          	auipc	ra,0x3
    30a6:	dd8080e7          	jalr	-552(ra) # 5e7a <printf>
    exit(1);
    30aa:	4505                	li	a0,1
...
00000000000030b4 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    30c4:	16050513          	addi	a0,a0,352 # 7220 <malloc+0x12ea>
  ...
  if(chdir("iputdir") < 0){
    ...
    30d8:	14c50513          	addi	a0,a0,332 # 7220 <malloc+0x12ea>
  ...
  if(unlink("../iputdir") < 0){
    ...
    30ec:	17850513          	addi	a0,a0,376 # 7260 <malloc+0x132a>
  ...
  if(chdir("/") < 0){
    ...
    3100:	19450513          	addi	a0,a0,404 # 7290 <malloc+0x135a>
    ...
    3120:	10c50513          	addi	a0,a0,268 # 7228 <malloc+0x12f2>
    3124:	00003097          	auipc	ra,0x3
    3128:	d56080e7          	jalr	-682(ra) # 5e7a <printf>
    exit(1);
    312c:	4505                	li	a0,1
    ...
    313c:	10850513          	addi	a0,a0,264 # 7240 <malloc+0x130a>
    3140:	00003097          	auipc	ra,0x3
    3144:	d3a080e7          	jalr	-710(ra) # 5e7a <printf>
    exit(1);
    3148:	4505                	li	a0,1
    ...
    3158:	11c50513          	addi	a0,a0,284 # 7270 <malloc+0x133a>
    315c:	00003097          	auipc	ra,0x3
    3160:	d1e080e7          	jalr	-738(ra) # 5e7a <printf>
    exit(1);
    3164:	4505                	li	a0,1
    ...
    3174:	12850513          	addi	a0,a0,296 # 7298 <malloc+0x1362>
    3178:	00003097          	auipc	ra,0x3
    317c:	d02080e7          	jalr	-766(ra) # 5e7a <printf>
    exit(1);
    3180:	4505                	li	a0,1
...
000000000000318a <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    31a8:	07c50513          	addi	a0,a0,124 # 7220 <malloc+0x12ea>
    ...
    31bc:	06850513          	addi	a0,a0,104 # 7220 <malloc+0x12ea>
    ...
    31d0:	09450513          	addi	a0,a0,148 # 7260 <malloc+0x132a>
    ...
    31f0:	6d450513          	addi	a0,a0,1748 # 68c0 <malloc+0x98a>
    31f4:	00003097          	auipc	ra,0x3
    31f8:	c86080e7          	jalr	-890(ra) # 5e7a <printf>
    exit(1);
    31fc:	4505                	li	a0,1
    ...
    320c:	02050513          	addi	a0,a0,32 # 7228 <malloc+0x12f2>
    3210:	00003097          	auipc	ra,0x3
    3214:	c6a080e7          	jalr	-918(ra) # 5e7a <printf>
      exit(1);
    3218:	4505                	li	a0,1
    ...
    3228:	08c50513          	addi	a0,a0,140 # 72b0 <malloc+0x137a>
    322c:	00003097          	auipc	ra,0x3
    3230:	c4e080e7          	jalr	-946(ra) # 5e7a <printf>
      exit(1);
    3234:	4505                	li	a0,1
    ...
    3244:	03050513          	addi	a0,a0,48 # 7270 <malloc+0x133a>
    3248:	00003097          	auipc	ra,0x3
    324c:	c32080e7          	jalr	-974(ra) # 5e7a <printf>
      exit(1);
    3250:	4505                	li	a0,1
...
0000000000003272 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    3282:	04a50513          	addi	a0,a0,74 # 72c8 <malloc+0x1392>
  ...
  if(chdir("dir0") < 0){
    ...
    3296:	03650513          	addi	a0,a0,54 # 72c8 <malloc+0x1392>
  ...
  if(chdir("..") < 0){
    ...
    32aa:	04250513          	addi	a0,a0,66 # 72e8 <malloc+0x13b2>
  ...
  if(unlink("dir0") < 0){
    ...
    32be:	00e50513          	addi	a0,a0,14 # 72c8 <malloc+0x1392>
    ...
    32de:	f4e50513          	addi	a0,a0,-178 # 7228 <malloc+0x12f2>
    32e2:	00003097          	auipc	ra,0x3
    32e6:	b98080e7          	jalr	-1128(ra) # 5e7a <printf>
    exit(1);
    32ea:	4505                	li	a0,1
    ...
    32fa:	fda50513          	addi	a0,a0,-38 # 72d0 <malloc+0x139a>
    32fe:	00003097          	auipc	ra,0x3
    3302:	b7c080e7          	jalr	-1156(ra) # 5e7a <printf>
    exit(1);
    3306:	4505                	li	a0,1
    ...
    3316:	fde50513          	addi	a0,a0,-34 # 72f0 <malloc+0x13ba>
    331a:	00003097          	auipc	ra,0x3
    331e:	b60080e7          	jalr	-1184(ra) # 5e7a <printf>
    exit(1);
    3322:	4505                	li	a0,1
    ...
    3332:	fda50513          	addi	a0,a0,-38 # 7308 <malloc+0x13d2>
    3336:	00003097          	auipc	ra,0x3
    333a:	b44080e7          	jalr	-1212(ra) # 5e7a <printf>
    exit(1);
    333e:	4505                	li	a0,1
...
0000000000003348 <subdir>:
{
  ...
  unlink("ff");
    ...
    335a:	0fa50513          	addi	a0,a0,250 # 7450 <malloc+0x151a>
    335e:	00003097          	auipc	ra,0x3
    3362:	816080e7          	jalr	-2026(ra) # 5b74 <unlink>
  if(mkdir("dd") != 0){
    3366:	00004517          	auipc	a0,0x4
    336a:	fba50513          	addi	a0,a0,-70 # 7320 <malloc+0x13ea>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3382:	fc250513          	addi	a0,a0,-62 # 7340 <malloc+0x140a>
  ...
  write(fd, "ff", 2);
    ...
    339a:	0ba58593          	addi	a1,a1,186 # 7450 <malloc+0x151a>
  ...
  if(unlink("dd") >= 0){
    ...
    33b4:	f7050513          	addi	a0,a0,-144 # 7320 <malloc+0x13ea>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    33c8:	fd450513          	addi	a0,a0,-44 # 7398 <malloc+0x1462>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    33e0:	fe450513          	addi	a0,a0,-28 # 73c0 <malloc+0x148a>
  ...
  write(fd, "FF", 2);
    ...
    33f8:	ffc58593          	addi	a1,a1,-4 # 73f0 <malloc+0x14ba>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3414:	fe850513          	addi	a0,a0,-24 # 73f8 <malloc+0x14c2>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    342c:	c7858593          	addi	a1,a1,-904 # c0a0 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    3442:	c6274703          	lbu	a4,-926(a4) # c0a0 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    345c:	ff058593          	addi	a1,a1,-16 # 7448 <malloc+0x1512>
    3460:	00004517          	auipc	a0,0x4
    3464:	f6050513          	addi	a0,a0,-160 # 73c0 <malloc+0x148a>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3478:	f4c50513          	addi	a0,a0,-180 # 73c0 <malloc+0x148a>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    348e:	f3650513          	addi	a0,a0,-202 # 73c0 <malloc+0x148a>
  ...
  if(chdir("dd") != 0){
    ...
    34a2:	e8250513          	addi	a0,a0,-382 # 7320 <malloc+0x13ea>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    34b6:	02e50513          	addi	a0,a0,46 # 74e0 <malloc+0x15aa>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    34ca:	04a50513          	addi	a0,a0,74 # 7510 <malloc+0x15da>
  ...
  if(chdir("./..") != 0){
    ...
    34de:	06650513          	addi	a0,a0,102 # 7540 <malloc+0x160a>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    34f4:	f5850513          	addi	a0,a0,-168 # 7448 <malloc+0x1512>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    350c:	b9858593          	addi	a1,a1,-1128 # c0a0 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    352e:	e9650513          	addi	a0,a0,-362 # 73c0 <malloc+0x148a>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3546:	08e50513          	addi	a0,a0,142 # 75d0 <malloc+0x169a>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    355e:	0a650513          	addi	a0,a0,166 # 7600 <malloc+0x16ca>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3576:	dae50513          	addi	a0,a0,-594 # 7320 <malloc+0x13ea>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    358c:	d9850513          	addi	a0,a0,-616 # 7320 <malloc+0x13ea>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    35a2:	d8250513          	addi	a0,a0,-638 # 7320 <malloc+0x13ea>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    35b6:	0de58593          	addi	a1,a1,222 # 7690 <malloc+0x175a>
    35ba:	00004517          	auipc	a0,0x4
    35be:	01650513          	addi	a0,a0,22 # 75d0 <malloc+0x169a>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    35d2:	0c258593          	addi	a1,a1,194 # 7690 <malloc+0x175a>
    35d6:	00004517          	auipc	a0,0x4
    35da:	02a50513          	addi	a0,a0,42 # 7600 <malloc+0x16ca>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    35ee:	e5e58593          	addi	a1,a1,-418 # 7448 <malloc+0x1512>
    35f2:	00004517          	auipc	a0,0x4
    35f6:	d4e50513          	addi	a0,a0,-690 # 7340 <malloc+0x140a>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    360a:	fca50513          	addi	a0,a0,-54 # 75d0 <malloc+0x169a>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    361e:	fe650513          	addi	a0,a0,-26 # 7600 <malloc+0x16ca>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3632:	e1a50513          	addi	a0,a0,-486 # 7448 <malloc+0x1512>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3646:	fbe50513          	addi	a0,a0,-66 # 7600 <malloc+0x16ca>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    365a:	f7a50513          	addi	a0,a0,-134 # 75d0 <malloc+0x169a>
  ...
  if(chdir("dd/ff") == 0){
    ...
    366e:	cd650513          	addi	a0,a0,-810 # 7340 <malloc+0x140a>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3682:	16250513          	addi	a0,a0,354 # 77e0 <malloc+0x18aa>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3696:	db650513          	addi	a0,a0,-586 # 7448 <malloc+0x1512>
  ...
  if(unlink("dd/ff") != 0){
    ...
    36aa:	c9a50513          	addi	a0,a0,-870 # 7340 <malloc+0x140a>
  ...
  if(unlink("dd") == 0){
    ...
    36be:	c6650513          	addi	a0,a0,-922 # 7320 <malloc+0x13ea>
  ...
  if(unlink("dd/dd") < 0){
    ...
    36d2:	18250513          	addi	a0,a0,386 # 7850 <malloc+0x191a>
  ...
  if(unlink("dd") < 0){
    ...
    36e6:	c3e50513          	addi	a0,a0,-962 # 7320 <malloc+0x13ea>
    ...
    3708:	c2450513          	addi	a0,a0,-988 # 7328 <malloc+0x13f2>
    370c:	00002097          	auipc	ra,0x2
    3710:	76e080e7          	jalr	1902(ra) # 5e7a <printf>
    exit(1);
    3714:	4505                	li	a0,1
    ...
    3724:	c2850513          	addi	a0,a0,-984 # 7348 <malloc+0x1412>
    3728:	00002097          	auipc	ra,0x2
    372c:	752080e7          	jalr	1874(ra) # 5e7a <printf>
    exit(1);
    3730:	4505                	li	a0,1
    ...
    3740:	c2c50513          	addi	a0,a0,-980 # 7368 <malloc+0x1432>
    3744:	00002097          	auipc	ra,0x2
    3748:	736080e7          	jalr	1846(ra) # 5e7a <printf>
    exit(1);
    374c:	4505                	li	a0,1
    ...
    375c:	c4850513          	addi	a0,a0,-952 # 73a0 <malloc+0x146a>
    3760:	00002097          	auipc	ra,0x2
    3764:	71a080e7          	jalr	1818(ra) # 5e7a <printf>
    exit(1);
    3768:	4505                	li	a0,1
    ...
    3778:	c5c50513          	addi	a0,a0,-932 # 73d0 <malloc+0x149a>
    377c:	00002097          	auipc	ra,0x2
    3780:	6fe080e7          	jalr	1790(ra) # 5e7a <printf>
    exit(1);
    3784:	4505                	li	a0,1
    ...
    3794:	c7850513          	addi	a0,a0,-904 # 7408 <malloc+0x14d2>
    3798:	00002097          	auipc	ra,0x2
    379c:	6e2080e7          	jalr	1762(ra) # 5e7a <printf>
    exit(1);
    37a0:	4505                	li	a0,1
    ...
    37b0:	c7c50513          	addi	a0,a0,-900 # 7428 <malloc+0x14f2>
    37b4:	00002097          	auipc	ra,0x2
    37b8:	6c6080e7          	jalr	1734(ra) # 5e7a <printf>
    exit(1);
    37bc:	4505                	li	a0,1
    ...
    37cc:	c9050513          	addi	a0,a0,-880 # 7458 <malloc+0x1522>
    37d0:	00002097          	auipc	ra,0x2
    37d4:	6aa080e7          	jalr	1706(ra) # 5e7a <printf>
    exit(1);
    37d8:	4505                	li	a0,1
    ...
    37e8:	c9c50513          	addi	a0,a0,-868 # 7480 <malloc+0x154a>
    37ec:	00002097          	auipc	ra,0x2
    37f0:	68e080e7          	jalr	1678(ra) # 5e7a <printf>
    exit(1);
    37f4:	4505                	li	a0,1
    ...
    3804:	ca050513          	addi	a0,a0,-864 # 74a0 <malloc+0x156a>
    3808:	00002097          	auipc	ra,0x2
    380c:	672080e7          	jalr	1650(ra) # 5e7a <printf>
    exit(1);
    3810:	4505                	li	a0,1
    ...
    3820:	cac50513          	addi	a0,a0,-852 # 74c8 <malloc+0x1592>
    3824:	00002097          	auipc	ra,0x2
    3828:	656080e7          	jalr	1622(ra) # 5e7a <printf>
    exit(1);
    382c:	4505                	li	a0,1
    ...
    383c:	cb850513          	addi	a0,a0,-840 # 74f0 <malloc+0x15ba>
    3840:	00002097          	auipc	ra,0x2
    3844:	63a080e7          	jalr	1594(ra) # 5e7a <printf>
    exit(1);
    3848:	4505                	li	a0,1
    ...
    3858:	ccc50513          	addi	a0,a0,-820 # 7520 <malloc+0x15ea>
    385c:	00002097          	auipc	ra,0x2
    3860:	61e080e7          	jalr	1566(ra) # 5e7a <printf>
    exit(1);
    3864:	4505                	li	a0,1
    ...
    3874:	cd850513          	addi	a0,a0,-808 # 7548 <malloc+0x1612>
    3878:	00002097          	auipc	ra,0x2
    387c:	602080e7          	jalr	1538(ra) # 5e7a <printf>
    exit(1);
    3880:	4505                	li	a0,1
    ...
    3890:	cd450513          	addi	a0,a0,-812 # 7560 <malloc+0x162a>
    3894:	00002097          	auipc	ra,0x2
    3898:	5e6080e7          	jalr	1510(ra) # 5e7a <printf>
    exit(1);
    389c:	4505                	li	a0,1
    ...
    38ac:	cd850513          	addi	a0,a0,-808 # 7580 <malloc+0x164a>
    38b0:	00002097          	auipc	ra,0x2
    38b4:	5ca080e7          	jalr	1482(ra) # 5e7a <printf>
    exit(1);
    38b8:	4505                	li	a0,1
    ...
    38c8:	cdc50513          	addi	a0,a0,-804 # 75a0 <malloc+0x166a>
    38cc:	00002097          	auipc	ra,0x2
    38d0:	5ae080e7          	jalr	1454(ra) # 5e7a <printf>
    exit(1);
    38d4:	4505                	li	a0,1
    ...
    38e4:	d0050513          	addi	a0,a0,-768 # 75e0 <malloc+0x16aa>
    38e8:	00002097          	auipc	ra,0x2
    38ec:	592080e7          	jalr	1426(ra) # 5e7a <printf>
    exit(1);
    38f0:	4505                	li	a0,1
    ...
    3900:	d1450513          	addi	a0,a0,-748 # 7610 <malloc+0x16da>
    3904:	00002097          	auipc	ra,0x2
    3908:	576080e7          	jalr	1398(ra) # 5e7a <printf>
    exit(1);
    390c:	4505                	li	a0,1
    ...
    391c:	d1850513          	addi	a0,a0,-744 # 7630 <malloc+0x16fa>
    3920:	00002097          	auipc	ra,0x2
    3924:	55a080e7          	jalr	1370(ra) # 5e7a <printf>
    exit(1);
    3928:	4505                	li	a0,1
    ...
    3938:	d1c50513          	addi	a0,a0,-740 # 7650 <malloc+0x171a>
    393c:	00002097          	auipc	ra,0x2
    3940:	53e080e7          	jalr	1342(ra) # 5e7a <printf>
    exit(1);
    3944:	4505                	li	a0,1
    ...
    3954:	d2050513          	addi	a0,a0,-736 # 7670 <malloc+0x173a>
    3958:	00002097          	auipc	ra,0x2
    395c:	522080e7          	jalr	1314(ra) # 5e7a <printf>
    exit(1);
    3960:	4505                	li	a0,1
    ...
    3970:	d3450513          	addi	a0,a0,-716 # 76a0 <malloc+0x176a>
    3974:	00002097          	auipc	ra,0x2
    3978:	506080e7          	jalr	1286(ra) # 5e7a <printf>
    exit(1);
    397c:	4505                	li	a0,1
    ...
    398c:	d4050513          	addi	a0,a0,-704 # 76c8 <malloc+0x1792>
    3990:	00002097          	auipc	ra,0x2
    3994:	4ea080e7          	jalr	1258(ra) # 5e7a <printf>
    exit(1);
    3998:	4505                	li	a0,1
    ...
    39a8:	d4c50513          	addi	a0,a0,-692 # 76f0 <malloc+0x17ba>
    39ac:	00002097          	auipc	ra,0x2
    39b0:	4ce080e7          	jalr	1230(ra) # 5e7a <printf>
    exit(1);
    39b4:	4505                	li	a0,1
    ...
    39c4:	d5850513          	addi	a0,a0,-680 # 7718 <malloc+0x17e2>
    39c8:	00002097          	auipc	ra,0x2
    39cc:	4b2080e7          	jalr	1202(ra) # 5e7a <printf>
    exit(1);
    39d0:	4505                	li	a0,1
    ...
    39e0:	d5c50513          	addi	a0,a0,-676 # 7738 <malloc+0x1802>
    39e4:	00002097          	auipc	ra,0x2
    39e8:	496080e7          	jalr	1174(ra) # 5e7a <printf>
    exit(1);
    39ec:	4505                	li	a0,1
    ...
    39fc:	d6050513          	addi	a0,a0,-672 # 7758 <malloc+0x1822>
    3a00:	00002097          	auipc	ra,0x2
    3a04:	47a080e7          	jalr	1146(ra) # 5e7a <printf>
    exit(1);
    3a08:	4505                	li	a0,1
    ...
    3a18:	d6c50513          	addi	a0,a0,-660 # 7780 <malloc+0x184a>
    3a1c:	00002097          	auipc	ra,0x2
    3a20:	45e080e7          	jalr	1118(ra) # 5e7a <printf>
    exit(1);
    3a24:	4505                	li	a0,1
    ...
    3a34:	d7050513          	addi	a0,a0,-656 # 77a0 <malloc+0x186a>
    3a38:	00002097          	auipc	ra,0x2
    3a3c:	442080e7          	jalr	1090(ra) # 5e7a <printf>
    exit(1);
    3a40:	4505                	li	a0,1
    ...
    3a50:	d7450513          	addi	a0,a0,-652 # 77c0 <malloc+0x188a>
    3a54:	00002097          	auipc	ra,0x2
    3a58:	426080e7          	jalr	1062(ra) # 5e7a <printf>
    exit(1);
    3a5c:	4505                	li	a0,1
    ...
    3a6c:	d8050513          	addi	a0,a0,-640 # 77e8 <malloc+0x18b2>
    3a70:	00002097          	auipc	ra,0x2
    3a74:	40a080e7          	jalr	1034(ra) # 5e7a <printf>
    exit(1);
    3a78:	4505                	li	a0,1
    ...
    3a88:	9fc50513          	addi	a0,a0,-1540 # 7480 <malloc+0x154a>
    3a8c:	00002097          	auipc	ra,0x2
    3a90:	3ee080e7          	jalr	1006(ra) # 5e7a <printf>
    exit(1);
    3a94:	4505                	li	a0,1
    ...
    3aa4:	d6850513          	addi	a0,a0,-664 # 7808 <malloc+0x18d2>
    3aa8:	00002097          	auipc	ra,0x2
    3aac:	3d2080e7          	jalr	978(ra) # 5e7a <printf>
    exit(1);
    3ab0:	4505                	li	a0,1
    ...
    3ac0:	d6c50513          	addi	a0,a0,-660 # 7828 <malloc+0x18f2>
    3ac4:	00002097          	auipc	ra,0x2
    3ac8:	3b6080e7          	jalr	950(ra) # 5e7a <printf>
    exit(1);
    3acc:	4505                	li	a0,1
    ...
    3adc:	d8050513          	addi	a0,a0,-640 # 7858 <malloc+0x1922>
    3ae0:	00002097          	auipc	ra,0x2
    3ae4:	39a080e7          	jalr	922(ra) # 5e7a <printf>
    exit(1);
    3ae8:	4505                	li	a0,1
    ...
    3af8:	d8450513          	addi	a0,a0,-636 # 7878 <malloc+0x1942>
    3afc:	00002097          	auipc	ra,0x2
    3b00:	37e080e7          	jalr	894(ra) # 5e7a <printf>
    exit(1);
    3b04:	4505                	li	a0,1
...
0000000000003b0e <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3b1e:	d7650513          	addi	a0,a0,-650 # 7890 <malloc+0x195a>
  ...
  if(unlink("..") == 0){
    ...
    3b54:	79850513          	addi	a0,a0,1944 # 72e8 <malloc+0x13b2>
  ...
  if(chdir("/") != 0){
    ...
    3b66:	72e50513          	addi	a0,a0,1838 # 7290 <malloc+0x135a>
  ...
  if(unlink("dots/.") == 0){
    ...
    3b78:	d8450513          	addi	a0,a0,-636 # 78f8 <malloc+0x19c2>
  ...
  if(unlink("dots/..") == 0){
    ...
    3b8a:	d9a50513          	addi	a0,a0,-614 # 7920 <malloc+0x19ea>
  ...
  if(unlink("dots") != 0){
    ...
    3b9c:	cf850513          	addi	a0,a0,-776 # 7890 <malloc+0x195a>
    ...
    3bba:	ce250513          	addi	a0,a0,-798 # 7898 <malloc+0x1962>
    3bbe:	00002097          	auipc	ra,0x2
    3bc2:	2bc080e7          	jalr	700(ra) # 5e7a <printf>
    exit(1);
    3bc6:	4505                	li	a0,1
    ...
    3bd6:	cde50513          	addi	a0,a0,-802 # 78b0 <malloc+0x197a>
    3bda:	00002097          	auipc	ra,0x2
    3bde:	2a0080e7          	jalr	672(ra) # 5e7a <printf>
    exit(1);
    3be2:	4505                	li	a0,1
    ...
    3bf2:	cda50513          	addi	a0,a0,-806 # 78c8 <malloc+0x1992>
    3bf6:	00002097          	auipc	ra,0x2
    3bfa:	284080e7          	jalr	644(ra) # 5e7a <printf>
    exit(1);
    3bfe:	4505                	li	a0,1
    ...
    3c0e:	cd650513          	addi	a0,a0,-810 # 78e0 <malloc+0x19aa>
    3c12:	00002097          	auipc	ra,0x2
    3c16:	268080e7          	jalr	616(ra) # 5e7a <printf>
    exit(1);
    3c1a:	4505                	li	a0,1
    ...
    3c2a:	67250513          	addi	a0,a0,1650 # 7298 <malloc+0x1362>
    3c2e:	00002097          	auipc	ra,0x2
    3c32:	24c080e7          	jalr	588(ra) # 5e7a <printf>
    exit(1);
    3c36:	4505                	li	a0,1
    ...
    3c46:	cbe50513          	addi	a0,a0,-834 # 7900 <malloc+0x19ca>
    3c4a:	00002097          	auipc	ra,0x2
    3c4e:	230080e7          	jalr	560(ra) # 5e7a <printf>
    exit(1);
    3c52:	4505                	li	a0,1
    ...
    3c62:	cca50513          	addi	a0,a0,-822 # 7928 <malloc+0x19f2>
    3c66:	00002097          	auipc	ra,0x2
    3c6a:	214080e7          	jalr	532(ra) # 5e7a <printf>
    exit(1);
    3c6e:	4505                	li	a0,1
    ...
    3c7e:	cce50513          	addi	a0,a0,-818 # 7948 <malloc+0x1a12>
    3c82:	00002097          	auipc	ra,0x2
    3c86:	1f8080e7          	jalr	504(ra) # 5e7a <printf>
    exit(1);
    3c8a:	4505                	li	a0,1
...
0000000000003c94 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3caa:	cc250513          	addi	a0,a0,-830 # 7968 <malloc+0x1a32>
  ...
  if(chdir("dirfile") == 0){
    ...
    3cc6:	ca650513          	addi	a0,a0,-858 # 7968 <malloc+0x1a32>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3cda:	cda50513          	addi	a0,a0,-806 # 79b0 <malloc+0x1a7a>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3cf2:	cc250513          	addi	a0,a0,-830 # 79b0 <malloc+0x1a7a>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3d06:	cae50513          	addi	a0,a0,-850 # 79b0 <malloc+0x1a7a>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3d1a:	c9a50513          	addi	a0,a0,-870 # 79b0 <malloc+0x1a7a>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3d2e:	c8658593          	addi	a1,a1,-890 # 79b0 <malloc+0x1a7a>
    3d32:	00002517          	auipc	a0,0x2
    3d36:	4de50513          	addi	a0,a0,1246 # 6210 <malloc+0x2da>
  ...
  if(unlink("dirfile") != 0){
    ...
    3d4a:	c2250513          	addi	a0,a0,-990 # 7968 <malloc+0x1a32>
  ...
  fd = open(".", O_RDWR);
    ...
    3d60:	9c450513          	addi	a0,a0,-1596 # 6720 <malloc+0x7ea>
  ...
  fd = open(".", 0);
    ...
    3d76:	9ae50513          	addi	a0,a0,-1618 # 6720 <malloc+0x7ea>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3d8a:	35258593          	addi	a1,a1,850 # 60d8 <malloc+0x1a2>
  ...
  close(fd);
    ...
    3db6:	bbe50513          	addi	a0,a0,-1090 # 7970 <malloc+0x1a3a>
    3dba:	00002097          	auipc	ra,0x2
    3dbe:	0c0080e7          	jalr	192(ra) # 5e7a <printf>
    exit(1);
    3dc2:	4505                	li	a0,1
    ...
    3dd2:	bc250513          	addi	a0,a0,-1086 # 7990 <malloc+0x1a5a>
    3dd6:	00002097          	auipc	ra,0x2
    3dda:	0a4080e7          	jalr	164(ra) # 5e7a <printf>
    exit(1);
    3dde:	4505                	li	a0,1
    ...
    3dee:	bd650513          	addi	a0,a0,-1066 # 79c0 <malloc+0x1a8a>
    3df2:	00002097          	auipc	ra,0x2
    3df6:	088080e7          	jalr	136(ra) # 5e7a <printf>
    exit(1);
    3dfa:	4505                	li	a0,1
    ...
    3e0a:	bba50513          	addi	a0,a0,-1094 # 79c0 <malloc+0x1a8a>
    3e0e:	00002097          	auipc	ra,0x2
    3e12:	06c080e7          	jalr	108(ra) # 5e7a <printf>
    exit(1);
    3e16:	4505                	li	a0,1
    ...
    3e26:	bc650513          	addi	a0,a0,-1082 # 79e8 <malloc+0x1ab2>
    3e2a:	00002097          	auipc	ra,0x2
    3e2e:	050080e7          	jalr	80(ra) # 5e7a <printf>
    exit(1);
    3e32:	4505                	li	a0,1
    ...
    3e42:	bd250513          	addi	a0,a0,-1070 # 7a10 <malloc+0x1ada>
    3e46:	00002097          	auipc	ra,0x2
    3e4a:	034080e7          	jalr	52(ra) # 5e7a <printf>
    exit(1);
    3e4e:	4505                	li	a0,1
    ...
    3e5e:	bde50513          	addi	a0,a0,-1058 # 7a38 <malloc+0x1b02>
    3e62:	00002097          	auipc	ra,0x2
    3e66:	018080e7          	jalr	24(ra) # 5e7a <printf>
    exit(1);
    3e6a:	4505                	li	a0,1
    ...
    3e7a:	bea50513          	addi	a0,a0,-1046 # 7a60 <malloc+0x1b2a>
    3e7e:	00002097          	auipc	ra,0x2
    3e82:	ffc080e7          	jalr	-4(ra) # 5e7a <printf>
    exit(1);
    3e86:	4505                	li	a0,1
    ...
    3e96:	bee50513          	addi	a0,a0,-1042 # 7a80 <malloc+0x1b4a>
    3e9a:	00002097          	auipc	ra,0x2
    3e9e:	fe0080e7          	jalr	-32(ra) # 5e7a <printf>
    exit(1);
    3ea2:	4505                	li	a0,1
    ...
    3eb2:	bfa50513          	addi	a0,a0,-1030 # 7aa8 <malloc+0x1b72>
    3eb6:	00002097          	auipc	ra,0x2
    3eba:	fc4080e7          	jalr	-60(ra) # 5e7a <printf>
    exit(1);
    3ebe:	4505                	li	a0,1
...
0000000000003ec8 <iref>:
{
    ...
    3ee8:	bdca8a93          	addi	s5,s5,-1060 # 7ac0 <malloc+0x1b8a>
    mkdir("");
    3eec:	00003497          	auipc	s1,0x3
    3ef0:	6dc48493          	addi	s1,s1,1756 # 75c8 <malloc+0x1692>
    link("README", "");
    3ef4:	00002b17          	auipc	s6,0x2
    3ef8:	31cb0b13          	addi	s6,s6,796 # 6210 <malloc+0x2da>
    fd = open("", O_CREATE);
    3efc:	20000a13          	li	s4,512
    fd = open("xx", O_CREATE);
    3f00:	00004997          	auipc	s3,0x4
    3f04:	ab898993          	addi	s3,s3,-1352 # 79b8 <malloc+0x1a82>
    3f08:	a891                	j	3f5c <iref+0x94>
      printf("%s: mkdir irefd failed\n", s);
    3f0a:	85de                	mv	a1,s7
    3f0c:	00004517          	auipc	a0,0x4
    3f10:	bbc50513          	addi	a0,a0,-1092 # 7ac8 <malloc+0x1b92>
    3f14:	00002097          	auipc	ra,0x2
    3f18:	f66080e7          	jalr	-154(ra) # 5e7a <printf>
      exit(1);
    3f1c:	4505                	li	a0,1
    ...
    3f2c:	bb850513          	addi	a0,a0,-1096 # 7ae0 <malloc+0x1baa>
    3f30:	00002097          	auipc	ra,0x2
    3f34:	f4a080e7          	jalr	-182(ra) # 5e7a <printf>
      exit(1);
    3f38:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3fbc:	33098993          	addi	s3,s3,816 # 72e8 <malloc+0x13b2>
    unlink("irefd");
    3fc0:	00004917          	auipc	s2,0x4
    3fc4:	b0090913          	addi	s2,s2,-1280 # 7ac0 <malloc+0x1b8a>
    chdir("..");
    3fc8:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3fe4:	2b050513          	addi	a0,a0,688 # 7290 <malloc+0x135a>
...
0000000000004006 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    4016:	ae650513          	addi	a0,a0,-1306 # 7af8 <malloc+0x1bc2>
  ...
  if(pid == 0){
    ...
    403a:	ac250513          	addi	a0,a0,-1342 # 7af8 <malloc+0x1bc2>
    ...
    4050:	acc50513          	addi	a0,a0,-1332 # 7b18 <malloc+0x1be2>
    4054:	00002097          	auipc	ra,0x2
    4058:	e26080e7          	jalr	-474(ra) # 5e7a <printf>
      exit(1);
    405c:	4505                	li	a0,1
    ...
    406c:	a9850513          	addi	a0,a0,-1384 # 7b00 <malloc+0x1bca>
    4070:	00002097          	auipc	ra,0x2
    4074:	e0a080e7          	jalr	-502(ra) # 5e7a <printf>
    exit(1);
    4078:	4505                	li	a0,1
    ...
    4088:	83c50513          	addi	a0,a0,-1988 # 68c0 <malloc+0x98a>
    408c:	00002097          	auipc	ra,0x2
    4090:	dee080e7          	jalr	-530(ra) # 5e7a <printf>
    exit(1);
    4094:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    40b6:	a4650513          	addi	a0,a0,-1466 # 7af8 <malloc+0x1bc2>
    ...
    40ca:	9ea50513          	addi	a0,a0,-1558 # 6ab0 <malloc+0xb7a>
    40ce:	00002097          	auipc	ra,0x2
    40d2:	dac080e7          	jalr	-596(ra) # 5e7a <printf>
    exit(1);
    40d6:	4505                	li	a0,1
...
00000000000040f8 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4108:	a3c50513          	addi	a0,a0,-1476 # 7b40 <malloc+0x1c0a>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    4134:	a1050513          	addi	a0,a0,-1520 # 7b40 <malloc+0x1c0a>
  ...
  sleep(10); // one second
    ...
    416c:	91850513          	addi	a0,a0,-1768 # 6a80 <malloc+0xb4a>
    4170:	00002097          	auipc	ra,0x2
    4174:	d0a080e7          	jalr	-758(ra) # 5e7a <printf>
    exit(1);
    4178:	4505                	li	a0,1
    ...
    4186:	9be48493          	addi	s1,s1,-1602 # 7b40 <malloc+0x1c0a>
    418a:	4581                	li	a1,0
    418c:	8526                	mv	a0,s1
    ...
    41ae:	99650513          	addi	a0,a0,-1642 # 7b40 <malloc+0x1c0a>
...
00000000000041ce <killstatus>:
{
  ...
  exit(0);
    ...
    423c:	68850513          	addi	a0,a0,1672 # 68c0 <malloc+0x98a>
    4240:	00002097          	auipc	ra,0x2
    4244:	c3a080e7          	jalr	-966(ra) # 5e7a <printf>
      exit(1);
    4248:	4505                	li	a0,1
    ...
    4262:	8f250513          	addi	a0,a0,-1806 # 7b50 <malloc+0x1c1a>
    4266:	00002097          	auipc	ra,0x2
    426a:	c14080e7          	jalr	-1004(ra) # 5e7a <printf>
       exit(1);
    426e:	4505                	li	a0,1
...
0000000000004278 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    42a2:	7e250513          	addi	a0,a0,2018 # 6a80 <malloc+0xb4a>
    42a6:	00002097          	auipc	ra,0x2
    42aa:	bd4080e7          	jalr	-1068(ra) # 5e7a <printf>
    exit(1);
    42ae:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    42d0:	5f450513          	addi	a0,a0,1524 # 68c0 <malloc+0x98a>
    42d4:	00002097          	auipc	ra,0x2
    42d8:	ba6080e7          	jalr	-1114(ra) # 5e7a <printf>
    exit(1);
    42dc:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    4314:	dc858593          	addi	a1,a1,-568 # 60d8 <malloc+0x1a2>
    ...
    433e:	58650513          	addi	a0,a0,1414 # 68c0 <malloc+0x98a>
    4342:	00002097          	auipc	ra,0x2
    4346:	b38080e7          	jalr	-1224(ra) # 5e7a <printf>
     exit(1);
    434a:	4505                	li	a0,1
    ...
    435a:	81a50513          	addi	a0,a0,-2022 # 7b70 <malloc+0x1c3a>
    435e:	00002097          	auipc	ra,0x2
    4362:	b1c080e7          	jalr	-1252(ra) # 5e7a <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    437a:	d2a58593          	addi	a1,a1,-726 # c0a0 <buf>
    ...
    4396:	7f650513          	addi	a0,a0,2038 # 7b88 <malloc+0x1c52>
    439a:	00002097          	auipc	ra,0x2
    439e:	ae0080e7          	jalr	-1312(ra) # 5e7a <printf>
}
  ...
  printf("kill... ");
    ...
    43c2:	7e250513          	addi	a0,a0,2018 # 7ba0 <malloc+0x1c6a>
    43c6:	00002097          	auipc	ra,0x2
    43ca:	ab4080e7          	jalr	-1356(ra) # 5e7a <printf>
  kill(pid1);
    43ce:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    43f0:	7c450513          	addi	a0,a0,1988 # 7bb0 <malloc+0x1c7a>
    43f4:	00002097          	auipc	ra,0x2
    43f8:	a86080e7          	jalr	-1402(ra) # 5e7a <printf>
  wait(0);
    43fc:	4501                	li	a0,0
...
000000000000441c <reparent>:
{
  ...
  exit(0);
    ...
    4470:	45450513          	addi	a0,a0,1108 # 68c0 <malloc+0x98a>
    4474:	00002097          	auipc	ra,0x2
    4478:	a06080e7          	jalr	-1530(ra) # 5e7a <printf>
      exit(1);
    447c:	4505                	li	a0,1
    ...
    448c:	5c050513          	addi	a0,a0,1472 # 6a48 <malloc+0xb12>
    4490:	00002097          	auipc	ra,0x2
    4494:	9ea080e7          	jalr	-1558(ra) # 5e7a <printf>
        exit(1);
    4498:	4505                	li	a0,1
...
00000000000044cc <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    450c:	4c050513          	addi	a0,a0,1216 # 69c8 <malloc+0xa92>
    4510:	00002097          	auipc	ra,0x2
    4514:	96a080e7          	jalr	-1686(ra) # 5e7a <printf>
    exit(1);
    4518:	4505                	li	a0,1
    ...
    4540:	b9c58593          	addi	a1,a1,-1124 # 60d8 <malloc+0x1a2>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    4608:	5bc50513          	addi	a0,a0,1468 # 7bc0 <malloc+0x1c8a>
    460c:	00002097          	auipc	ra,0x2
    4610:	86e080e7          	jalr	-1938(ra) # 5e7a <printf>
    exit(1);
    4614:	4505                	li	a0,1
    ...
    4624:	2a050513          	addi	a0,a0,672 # 68c0 <malloc+0x98a>
    4628:	00002097          	auipc	ra,0x2
    462c:	852080e7          	jalr	-1966(ra) # 5e7a <printf>
    exit(1);
    4630:	4505                	li	a0,1
    ...
    465a:	6705                	lui	a4,0x1
      n += *(a+i);
    465c:	0007c603          	lbu	a2,0(a5) # 6400000 <__BSS_END__+0x63f0f50>
    ...
    4670:	57450513          	addi	a0,a0,1396 # 7be0 <malloc+0x1caa>
    4674:	00002097          	auipc	ra,0x2
    4678:	806080e7          	jalr	-2042(ra) # 5e7a <printf>
    exit(1);
    467c:	4505                	li	a0,1
...
0000000000004690 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    46da:	860080e7          	jalr	-1952(ra) # 5f36 <malloc>
    ...
    4714:	50050513          	addi	a0,a0,1280 # 7c10 <malloc+0x1cda>
    4718:	00001097          	auipc	ra,0x1
    471c:	762080e7          	jalr	1890(ra) # 5e7a <printf>
      exit(1);
    4720:	4505                	li	a0,1
...
0000000000004734 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    47e0:	46450513          	addi	a0,a0,1124 # 7c40 <malloc+0x1d0a>
    47e4:	00001097          	auipc	ra,0x1
    47e8:	696080e7          	jalr	1686(ra) # 5e7a <printf>
    exit(1);
    47ec:	4505                	li	a0,1
    ...
    4802:	46a50513          	addi	a0,a0,1130 # 7c68 <malloc+0x1d32>
    4806:	00001097          	auipc	ra,0x1
    480a:	674080e7          	jalr	1652(ra) # 5e7a <printf>
      exit(1);
    480e:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    484e:	3e650513          	addi	a0,a0,998 # 7c30 <malloc+0x1cfa>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    489a:	3f250513          	addi	a0,a0,1010 # 7c88 <malloc+0x1d52>
    489e:	00001097          	auipc	ra,0x1
    48a2:	5dc080e7          	jalr	1500(ra) # 5e7a <printf>
    exit(1);
    48a6:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    48d6:	35e50513          	addi	a0,a0,862 # 7c30 <malloc+0x1cfa>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    48fc:	3b850513          	addi	a0,a0,952 # 7cb0 <malloc+0x1d7a>
    4900:	00001097          	auipc	ra,0x1
    4904:	57a080e7          	jalr	1402(ra) # 5e7a <printf>
    exit(1);
    4908:	4505                	li	a0,1
...
000000000000491c <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4940:	38c78793          	addi	a5,a5,908 # 7cc8 <malloc+0x1d92>
    4944:	f6f43823          	sd	a5,-144(s0)
    4948:	00003797          	auipc	a5,0x3
    494c:	38878793          	addi	a5,a5,904 # 7cd0 <malloc+0x1d9a>
    4950:	f6f43c23          	sd	a5,-136(s0)
    4954:	00003797          	auipc	a5,0x3
    4958:	38478793          	addi	a5,a5,900 # 7cd8 <malloc+0x1da2>
    495c:	f8f43023          	sd	a5,-128(s0)
    4960:	00003797          	auipc	a5,0x3
    4964:	38078793          	addi	a5,a5,896 # 7ce0 <malloc+0x1daa>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    49c0:	6e4a0a13          	addi	s4,s4,1764 # c0a0 <buf>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    49d6:	30e50513          	addi	a0,a0,782 # 6ce0 <malloc+0xdaa>
    49da:	00001097          	auipc	ra,0x1
    49de:	4a0080e7          	jalr	1184(ra) # 5e7a <printf>
      exit(1);
    49e2:	4505                	li	a0,1
    ...
    4a0c:	69850513          	addi	a0,a0,1688 # c0a0 <buf>
    ...
    4a22:	682a0a13          	addi	s4,s4,1666 # c0a0 <buf>
    4a26:	864e                	mv	a2,s3
    4a28:	85d2                	mv	a1,s4
    4a2a:	854a                	mv	a0,s2
    ...
    4a4e:	29e50513          	addi	a0,a0,670 # 7ce8 <malloc+0x1db2>
    4a52:	00001097          	auipc	ra,0x1
    4a56:	428080e7          	jalr	1064(ra) # 5e7a <printf>
        exit(1);
    4a5a:	4505                	li	a0,1
    ...
    4a68:	29450513          	addi	a0,a0,660 # 7cf8 <malloc+0x1dc2>
    4a6c:	00001097          	auipc	ra,0x1
    4a70:	40e080e7          	jalr	1038(ra) # 5e7a <printf>
          exit(1);
    4a74:	4505                	li	a0,1
    ...
    4a8e:	28650513          	addi	a0,a0,646 # 7d10 <malloc+0x1dda>
    4a92:	00001097          	auipc	ra,0x1
    4a96:	3e8080e7          	jalr	1000(ra) # 5e7a <printf>
          exit(1);
    4a9a:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4aee:	5b678793          	addi	a5,a5,1462 # c0a0 <buf>
    ...
    4b10:	21450513          	addi	a0,a0,532 # 7d20 <malloc+0x1dea>
    4b14:	00001097          	auipc	ra,0x1
    4b18:	366080e7          	jalr	870(ra) # 5e7a <printf>
      exit(1);
    4b1c:	4505                	li	a0,1
...
0000000000004b44 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4b78:	556b0b13          	addi	s6,s6,1366 # 55555556 <__BSS_END__+0x555464a6>
    4b7c:	4c05                	li	s8,1
      fd = open(file, O_CREATE | O_RDWR);
    4b7e:	20200c93          	li	s9,514
      link("C0", file);
    4b82:	00003d17          	auipc	s10,0x3
    4b86:	1b6d0d13          	addi	s10,s10,438 # 7d38 <malloc+0x1e02>
      wait(&xstatus);
  ...
  for(i = 0; i < N; i++){
    ...
    4ba6:	66778793          	addi	a5,a5,1639 # 66666667 <__BSS_END__+0x666575b7>
    ...
    4be2:	16250513          	addi	a0,a0,354 # 7d40 <malloc+0x1e0a>
    4be6:	00001097          	auipc	ra,0x1
    4bea:	294080e7          	jalr	660(ra) # 5e7a <printf>
        exit(1);
    4bee:	4505                	li	a0,1
    ...
    4c00:	13c50513          	addi	a0,a0,316 # 7d38 <malloc+0x1e02>
  ...
  fd = open(".", 0);
    ...
    4c38:	aec50513          	addi	a0,a0,-1300 # 6720 <malloc+0x7ea>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4cae:	0b650513          	addi	a0,a0,182 # 7d60 <malloc+0x1e2a>
    4cb2:	00001097          	auipc	ra,0x1
    4cb6:	1c8080e7          	jalr	456(ra) # 5e7a <printf>
        exit(1);
    4cba:	4505                	li	a0,1
    ...
    4cce:	0b650513          	addi	a0,a0,182 # 7d80 <malloc+0x1e4a>
    4cd2:	00001097          	auipc	ra,0x1
    4cd6:	1a8080e7          	jalr	424(ra) # 5e7a <printf>
        exit(1);
    4cda:	4505                	li	a0,1
  ...
  if(n != N){
    ...
    4cfa:	556a0a13          	addi	s4,s4,1366 # 55555556 <__BSS_END__+0x555464a6>
      close(open(file, 0));
  ...
  for(i = 0; i < N; i++){
    ...
    4d0e:	09e50513          	addi	a0,a0,158 # 7da8 <malloc+0x1e72>
    4d12:	00001097          	auipc	ra,0x1
    4d16:	168080e7          	jalr	360(ra) # 5e7a <printf>
    exit(1);
    4d1a:	4505                	li	a0,1
    ...
    4d2a:	b9a50513          	addi	a0,a0,-1126 # 68c0 <malloc+0x98a>
    4d2e:	00001097          	auipc	ra,0x1
    4d32:	14c080e7          	jalr	332(ra) # 5e7a <printf>
      exit(1);
    4d36:	4505                	li	a0,1
...
0000000000004ede <bigfile>:
{
  ...
  if(fd < 0){
    ...
    4f28:	17c98993          	addi	s3,s3,380 # c0a0 <buf>
  for(i = 0; i < N; i++){
    4f2c:	4ad1                	li	s5,20
    memset(buf, i, SZ);
    4f2e:	864a                	mv	a2,s2
  ...
  fd = open("bigfile.dat", 0);
    ...
    4f64:	e8050513          	addi	a0,a0,-384 # 7de0 <malloc+0x1eaa>
  ...
  for(i = 0; ; i++){
    ...
    4f7e:	12690913          	addi	s2,s2,294 # c0a0 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4fc6:	e2e50513          	addi	a0,a0,-466 # 7df0 <malloc+0x1eba>
    4fca:	00001097          	auipc	ra,0x1
    4fce:	eb0080e7          	jalr	-336(ra) # 5e7a <printf>
    exit(1);
    4fd2:	4505                	li	a0,1
    ...
    4fe2:	e3250513          	addi	a0,a0,-462 # 7e10 <malloc+0x1eda>
    4fe6:	00001097          	auipc	ra,0x1
    4fea:	e94080e7          	jalr	-364(ra) # 5e7a <printf>
      exit(1);
    4fee:	4505                	li	a0,1
    ...
    4ffe:	e3650513          	addi	a0,a0,-458 # 7e30 <malloc+0x1efa>
    5002:	00001097          	auipc	ra,0x1
    5006:	e78080e7          	jalr	-392(ra) # 5e7a <printf>
    exit(1);
    500a:	4505                	li	a0,1
    ...
    501a:	e3a50513          	addi	a0,a0,-454 # 7e50 <malloc+0x1f1a>
    501e:	00001097          	auipc	ra,0x1
    5022:	e5c080e7          	jalr	-420(ra) # 5e7a <printf>
      exit(1);
    5026:	4505                	li	a0,1
    ...
    5036:	e3e50513          	addi	a0,a0,-450 # 7e70 <malloc+0x1f3a>
    503a:	00001097          	auipc	ra,0x1
    503e:	e40080e7          	jalr	-448(ra) # 5e7a <printf>
      exit(1);
    5042:	4505                	li	a0,1
    ...
    5052:	e3a50513          	addi	a0,a0,-454 # 7e88 <malloc+0x1f52>
    5056:	00001097          	auipc	ra,0x1
    505a:	e24080e7          	jalr	-476(ra) # 5e7a <printf>
      exit(1);
    505e:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    5080:	d6450513          	addi	a0,a0,-668 # 7de0 <malloc+0x1eaa>
    ...
    50a6:	e0650513          	addi	a0,a0,-506 # 7ea8 <malloc+0x1f72>
    50aa:	00001097          	auipc	ra,0x1
    50ae:	dd0080e7          	jalr	-560(ra) # 5e7a <printf>
    exit(1);
    50b2:	4505                	li	a0,1
...
00000000000050bc <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    50de:	dee50513          	addi	a0,a0,-530 # 7ec8 <malloc+0x1f92>
    50e2:	00001097          	auipc	ra,0x1
    50e6:	d98080e7          	jalr	-616(ra) # 5e7a <printf>
  for(nfiles = 0; ; nfiles++){
    50ea:	4481                	li	s1,0
    name[0] = 'f';
    ...
    50f4:	dd3c8c93          	addi	s9,s9,-557 # 10624dd3 <__BSS_END__+0x10615d23>
    name[2] = '0' + (nfiles % 1000) / 100;
    50f8:	51eb8ab7          	lui	s5,0x51eb8
    50fc:	51fa8a93          	addi	s5,s5,1311 # 51eb851f <__BSS_END__+0x51ea946f>
    name[3] = '0' + (nfiles % 100) / 10;
    5100:	66666a37          	lui	s4,0x66666
    5104:	667a0a13          	addi	s4,s4,1639 # 66666667 <__BSS_END__+0x666575b7>
    printf("writing %s\n", name);
    ...
    5198:	d4450513          	addi	a0,a0,-700 # 7ed8 <malloc+0x1fa2>
    519c:	00001097          	auipc	ra,0x1
    51a0:	cde080e7          	jalr	-802(ra) # 5e7a <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    51c0:	d2c50513          	addi	a0,a0,-724 # 7ee8 <malloc+0x1fb2>
    51c4:	00001097          	auipc	ra,0x1
    51c8:	cb6080e7          	jalr	-842(ra) # 5e7a <printf>
    name[0] = 'f';
    51cc:	06600c13          	li	s8,102
    name[1] = '0' + nfiles / 1000;
    51d0:	10625a37          	lui	s4,0x10625
    51d4:	dd3a0a13          	addi	s4,s4,-557 # 10624dd3 <__BSS_END__+0x10615d23>
    name[2] = '0' + (nfiles % 1000) / 100;
    51d8:	3e800b93          	li	s7,1000
    51dc:	51eb89b7          	lui	s3,0x51eb8
    51e0:	51f98993          	addi	s3,s3,1311 # 51eb851f <__BSS_END__+0x51ea946f>
    name[3] = '0' + (nfiles % 100) / 10;
    51e4:	06400b13          	li	s6,100
    51e8:	66666937          	lui	s2,0x66666
    51ec:	66790913          	addi	s2,s2,1639 # 66666667 <__BSS_END__+0x666575b7>
    unlink(name);
  ...
  printf("fsfull test finished\n");
    ...
    5286:	c8650513          	addi	a0,a0,-890 # 7f08 <malloc+0x1fd2>
    528a:	00001097          	auipc	ra,0x1
    528e:	bf0080e7          	jalr	-1040(ra) # 5e7a <printf>
}
    ...
    52ba:	deab8b93          	addi	s7,s7,-534 # c0a0 <buf>
      if(cc < BSIZE)
    ...
    52e0:	c1c50513          	addi	a0,a0,-996 # 7ef8 <malloc+0x1fc2>
    52e4:	00001097          	auipc	ra,0x1
    52e8:	b96080e7          	jalr	-1130(ra) # 5e7a <printf>
    close(fd);
    52ec:	854a                	mv	a0,s2
...
00000000000052fe <badwrite>:
{
  ...
  unlink("junk");
    ...
    5316:	c0e50513          	addi	a0,a0,-1010 # 7f20 <malloc+0x1fea>
    ...
    532e:	bf698993          	addi	s3,s3,-1034 # 7f20 <malloc+0x1fea>
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    537a:	baa50513          	addi	a0,a0,-1110 # 7f20 <malloc+0x1fea>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    5392:	d4a58593          	addi	a1,a1,-694 # 60d8 <malloc+0x1a2>
    ...
    53a8:	b9c50513          	addi	a0,a0,-1124 # 7f40 <malloc+0x200a>
    53ac:	00001097          	auipc	ra,0x1
    53b0:	ace080e7          	jalr	-1330(ra) # 5e7a <printf>
    exit(1);
    53b4:	4505                	li	a0,1
    ...
    53c2:	b6a50513          	addi	a0,a0,-1174 # 7f28 <malloc+0x1ff2>
    53c6:	00001097          	auipc	ra,0x1
    53ca:	ab4080e7          	jalr	-1356(ra) # 5e7a <printf>
      exit(1);
    53ce:	4505                	li	a0,1
    ...
    53dc:	b5050513          	addi	a0,a0,-1200 # 7f28 <malloc+0x1ff2>
    53e0:	00001097          	auipc	ra,0x1
    53e4:	a9a080e7          	jalr	-1382(ra) # 5e7a <printf>
    exit(1);
    53e8:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    5400:	b2450513          	addi	a0,a0,-1244 # 7f20 <malloc+0x1fea>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    545a:	c82a0a13          	addi	s4,s4,-894 # 60d8 <malloc+0x1a2>
      uint64 a = (uint64) sbrk(4096);
    545e:	854a                	mv	a0,s2
    ...
    548a:	b0a50513          	addi	a0,a0,-1270 # 7f90 <malloc+0x205a>
    548e:	00001097          	auipc	ra,0x1
    5492:	9ec080e7          	jalr	-1556(ra) # 5e7a <printf>
        exit(1);
    5496:	4505                	li	a0,1
    ...
    54ac:	aa850513          	addi	a0,a0,-1368 # 7f50 <malloc+0x201a>
    54b0:	00001097          	auipc	ra,0x1
    54b4:	9ca080e7          	jalr	-1590(ra) # 5e7a <printf>
    exit(1);
    54b8:	4505                	li	a0,1
    ...
    54ce:	aa650513          	addi	a0,a0,-1370 # 7f70 <malloc+0x203a>
    54d2:	00001097          	auipc	ra,0x1
    54d6:	9a8080e7          	jalr	-1624(ra) # 5e7a <printf>
    exit(1);
    54da:	4505                	li	a0,1
  ...
  while(1){
    ...
    5528:	a8c50513          	addi	a0,a0,-1396 # 7fb0 <malloc+0x207a>
    552c:	00001097          	auipc	ra,0x1
    5530:	94e080e7          	jalr	-1714(ra) # 5e7a <printf>
      exit(1);
    5534:	4505                	li	a0,1
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5578:	a5c50513          	addi	a0,a0,-1444 # 7fd0 <malloc+0x209a>
    557c:	00001097          	auipc	ra,0x1
    5580:	8fe080e7          	jalr	-1794(ra) # 5e7a <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    55a8:	a5450513          	addi	a0,a0,-1452 # 7ff8 <malloc+0x20c2>
    55ac:	00001097          	auipc	ra,0x1
    55b0:	8ce080e7          	jalr	-1842(ra) # 5e7a <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    55cc:	a1850513          	addi	a0,a0,-1512 # 7fe0 <malloc+0x20aa>
    55d0:	00001097          	auipc	ra,0x1
    55d4:	8aa080e7          	jalr	-1878(ra) # 5e7a <printf>
    exit(1);
    55d8:	4505                	li	a0,1
    ...
    55f4:	a1050513          	addi	a0,a0,-1520 # 8000 <malloc+0x20ca>
    55f8:	00001097          	auipc	ra,0x1
    55fc:	882080e7          	jalr	-1918(ra) # 5e7a <printf>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    563e:	de678793          	addi	a5,a5,-538 # 8420 <malloc+0x24ea>
    5642:	bd040713          	addi	a4,s0,-1072
    5646:	00003697          	auipc	a3,0x3
    564a:	1ca68693          	addi	a3,a3,458 # 8810 <malloc+0x28da>
  ...
  printf("usertests starting\n");
    ...
    5682:	a4250513          	addi	a0,a0,-1470 # 80c0 <malloc+0x218a>
    5686:	00000097          	auipc	ra,0x0
    568a:	7f4080e7          	jalr	2036(ra) # 5e7a <printf>
  int free0 = countfree();
  ...
  if(fail){
    ...
    56ba:	9c250513          	addi	a0,a0,-1598 # 8078 <malloc+0x2142>
    56be:	00000097          	auipc	ra,0x0
    56c2:	7bc080e7          	jalr	1980(ra) # 5e7a <printf>
    exit(1);
    56c6:	4505                	li	a0,1
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    56e6:	92658593          	addi	a1,a1,-1754 # 8008 <malloc+0x20d2>
    ...
    56fc:	d2878793          	addi	a5,a5,-728 # 8420 <malloc+0x24ea>
    5700:	bd040713          	addi	a4,s0,-1072
    5704:	00003697          	auipc	a3,0x3
    5708:	10c68693          	addi	a3,a3,268 # 8810 <malloc+0x28da>
    ...
    5740:	99c50513          	addi	a0,a0,-1636 # 80d8 <malloc+0x21a2>
    5744:	00000097          	auipc	ra,0x0
    5748:	736080e7          	jalr	1846(ra) # 5e7a <printf>
        printf("SOME TESTS FAILED\n");
    574c:	00003a97          	auipc	s5,0x3
    5750:	914a8a93          	addi	s5,s5,-1772 # 8060 <malloc+0x212a>
        if(continuous != 2)
    5754:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    5756:	00003b17          	auipc	s6,0x3
    575a:	8eab0b13          	addi	s6,s6,-1814 # 8040 <malloc+0x210a>
    575e:	a8fd                	j	585c <main+0x25a>
  } else if(argc == 2 && strcmp(argv[1], "-C") == 0){
    5760:	00003597          	auipc	a1,0x3
    5764:	8b058593          	addi	a1,a1,-1872 # 8010 <malloc+0x20da>
    ...
    579a:	88250513          	addi	a0,a0,-1918 # 8018 <malloc+0x20e2>
    579e:	00000097          	auipc	ra,0x0
    57a2:	6dc080e7          	jalr	1756(ra) # 5e7a <printf>
    exit(1);
    57a6:	4505                	li	a0,1
    ...
    57c4:	6ba080e7          	jalr	1722(ra) # 5e7a <printf>
        if(continuous != 2)
  ...
  if(fail){
    ...
    5812:	85250513          	addi	a0,a0,-1966 # 8060 <malloc+0x212a>
    5816:	00000097          	auipc	ra,0x0
    581a:	664080e7          	jalr	1636(ra) # 5e7a <printf>
    exit(1);
    581e:	4505                	li	a0,1
    ...
    582c:	88050513          	addi	a0,a0,-1920 # 80a8 <malloc+0x2172>
    5830:	00000097          	auipc	ra,0x0
    5834:	64a080e7          	jalr	1610(ra) # 5e7a <printf>
    exit(0);
    5838:	4501                	li	a0,0
    ...
    5848:	636080e7          	jalr	1590(ra) # 5e7a <printf>
        if(continuous != 2)
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    5bda:	f6e080e7          	jalr	-146(ra) # 5b44 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
    ...
    5bec:	f426                	sd	s1,40(sp)
    5bee:	f04a                	sd	s2,32(sp)
    5bf0:	ec4e                	sd	s3,24(sp)
  ...
  neg = 0;
  if(sgn && xx < 0){
    5bf6:	c299                	beqz	a3,5bfc <printint+0x16>
    5bf8:	0805c063          	bltz	a1,5c78 <printint+0x92>
  neg = 0;
    5bfc:	4e01                	li	t3,0
    x = -xx;
  } else {
  ...
  do{
    buf[i++] = digits[x % base];
    5c06:	00003817          	auipc	a6,0x3
    5c0a:	c6280813          	addi	a6,a6,-926 # 8868 <digits>
    5c0e:	88be                	mv	a7,a5
    5c10:	0017851b          	addiw	a0,a5,1
    5c14:	87aa                	mv	a5,a0
    5c16:	02c5f73b          	remuw	a4,a1,a2
    5c1a:	1702                	slli	a4,a4,0x20
    5c1c:	9301                	srli	a4,a4,0x20
    5c1e:	9742                	add	a4,a4,a6
    5c20:	00074703          	lbu	a4,0(a4)
    5c24:	00e68023          	sb	a4,0(a3)
  }while((x /= base) != 0);
    5c28:	872e                	mv	a4,a1
    5c2a:	02c5d5bb          	divuw	a1,a1,a2
    5c2e:	0685                	addi	a3,a3,1
    5c30:	fcc77fe3          	bgeu	a4,a2,5c0e <printint+0x28>
  if(neg)
    5c34:	000e0c63          	beqz	t3,5c4c <printint+0x66>
    buf[i++] = '-';
    5c38:	fd050793          	addi	a5,a0,-48
    5c3c:	00878533          	add	a0,a5,s0
    5c40:	02d00793          	li	a5,45
    5c44:	fef50823          	sb	a5,-16(a0)
    5c48:	0028879b          	addiw	a5,a7,2

  while(--i >= 0)
    5c4c:	fff7899b          	addiw	s3,a5,-1
    5c50:	006784b3          	add	s1,a5,t1
    putc(fd, buf[i]);
    5c54:	fff4c583          	lbu	a1,-1(s1)
    5c58:	854a                	mv	a0,s2
    5c5a:	00000097          	auipc	ra,0x0
    5c5e:	f6a080e7          	jalr	-150(ra) # 5bc4 <putc>
  while(--i >= 0)
    5c62:	39fd                	addiw	s3,s3,-1
    5c64:	14fd                	addi	s1,s1,-1
    5c66:	fe09d7e3          	bgez	s3,5c54 <printint+0x6e>
}
    5c6a:	70e2                	ld	ra,56(sp)
    5c6c:	7442                	ld	s0,48(sp)
    5c6e:	74a2                	ld	s1,40(sp)
    5c70:	7902                	ld	s2,32(sp)
    5c72:	69e2                	ld	s3,24(sp)
    5c74:	6121                	addi	sp,sp,64
    5c76:	8082                	ret
    x = -xx;
    5c78:	40b005bb          	negw	a1,a1
    neg = 1;
    5c7c:	4e05                	li	t3,1
    x = -xx;
    5c7e:	b741                	j	5bfe <printint+0x18>

0000000000005c80 <vprintf>:
}
...
{
    5c80:	715d                	addi	sp,sp,-80
    5c82:	e486                	sd	ra,72(sp)
    5c84:	e0a2                	sd	s0,64(sp)
    5c86:	f84a                	sd	s2,48(sp)
    5c88:	0880                	addi	s0,sp,80
  char *s;
  int c, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    5c8a:	0005c903          	lbu	s2,0(a1)
    5c8e:	1a090a63          	beqz	s2,5e42 <vprintf+0x1c2>
    5c92:	fc26                	sd	s1,56(sp)
    5c94:	f44e                	sd	s3,40(sp)
    5c96:	f052                	sd	s4,32(sp)
    5c98:	ec56                	sd	s5,24(sp)
    5c9a:	e85a                	sd	s6,16(sp)
    5c9c:	e45e                	sd	s7,8(sp)
    5c9e:	8aaa                	mv	s5,a0
    5ca0:	8bb2                	mv	s7,a2
    5ca2:	00158493          	addi	s1,a1,1
  state = 0;
    5ca6:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    5ca8:	02500a13          	li	s4,37
    5cac:	4b55                	li	s6,21
    5cae:	a839                	j	5ccc <vprintf+0x4c>
        putc(fd, c);
    5cb0:	85ca                	mv	a1,s2
    5cb2:	8556                	mv	a0,s5
    5cb4:	00000097          	auipc	ra,0x0
    5cb8:	f10080e7          	jalr	-240(ra) # 5bc4 <putc>
    5cbc:	a019                	j	5cc2 <vprintf+0x42>
    } else if(state == '%'){
    5cbe:	01498d63          	beq	s3,s4,5cd8 <vprintf+0x58>
  for(i = 0; fmt[i]; i++){
    5cc2:	0485                	addi	s1,s1,1
    5cc4:	fff4c903          	lbu	s2,-1(s1)
    5cc8:	16090763          	beqz	s2,5e36 <vprintf+0x1b6>
    if(state == 0){
    5ccc:	fe0999e3          	bnez	s3,5cbe <vprintf+0x3e>
      if(c == '%'){
    5cd0:	ff4910e3          	bne	s2,s4,5cb0 <vprintf+0x30>
        state = '%';
    5cd4:	89d2                	mv	s3,s4
    5cd6:	b7f5                	j	5cc2 <vprintf+0x42>
      if(c == 'd'){
    5cd8:	13490463          	beq	s2,s4,5e00 <vprintf+0x180>
    5cdc:	f9d9079b          	addiw	a5,s2,-99
    5ce0:	0ff7f793          	zext.b	a5,a5
    5ce4:	12fb6763          	bltu	s6,a5,5e12 <vprintf+0x192>
    5ce8:	f9d9079b          	addiw	a5,s2,-99
    5cec:	0ff7f713          	zext.b	a4,a5
    5cf0:	12eb6163          	bltu	s6,a4,5e12 <vprintf+0x192>
    5cf4:	00271793          	slli	a5,a4,0x2
    5cf8:	00003717          	auipc	a4,0x3
    5cfc:	b1870713          	addi	a4,a4,-1256 # 8810 <malloc+0x28da>
    5d00:	97ba                	add	a5,a5,a4
    5d02:	439c                	lw	a5,0(a5)
    5d04:	97ba                	add	a5,a5,a4
    5d06:	8782                	jr	a5
        printint(fd, va_arg(ap, int), 10, 1);
    5d08:	008b8913          	addi	s2,s7,8
    5d0c:	4685                	li	a3,1
    5d0e:	4629                	li	a2,10
    5d10:	000ba583          	lw	a1,0(s7)
    5d14:	8556                	mv	a0,s5
    5d16:	00000097          	auipc	ra,0x0
    5d1a:	ed0080e7          	jalr	-304(ra) # 5be6 <printint>
    5d1e:	8bca                	mv	s7,s2
      } else {
      ...
      state = 0;
    5d20:	4981                	li	s3,0
    5d22:	b745                	j	5cc2 <vprintf+0x42>
        printint(fd, va_arg(ap, uint64), 10, 0);
    5d24:	008b8913          	addi	s2,s7,8
    5d28:	4681                	li	a3,0
    5d2a:	4629                	li	a2,10
    5d2c:	000ba583          	lw	a1,0(s7)
    5d30:	8556                	mv	a0,s5
    5d32:	00000097          	auipc	ra,0x0
    5d36:	eb4080e7          	jalr	-332(ra) # 5be6 <printint>
    5d3a:	8bca                	mv	s7,s2
      state = 0;
    5d3c:	4981                	li	s3,0
    5d3e:	b751                	j	5cc2 <vprintf+0x42>
        printint(fd, va_arg(ap, int), 16, 0);
    5d40:	008b8913          	addi	s2,s7,8
    5d44:	4681                	li	a3,0
    5d46:	4641                	li	a2,16
    5d48:	000ba583          	lw	a1,0(s7)
    5d4c:	8556                	mv	a0,s5
    5d4e:	00000097          	auipc	ra,0x0
    5d52:	e98080e7          	jalr	-360(ra) # 5be6 <printint>
    5d56:	8bca                	mv	s7,s2
      state = 0;
    5d58:	4981                	li	s3,0
    5d5a:	b7a5                	j	5cc2 <vprintf+0x42>
    5d5c:	e062                	sd	s8,0(sp)
        printptr(fd, va_arg(ap, uint64));
    5d5e:	008b8c13          	addi	s8,s7,8
    5d62:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    5d66:	03000593          	li	a1,48
    5d6a:	8556                	mv	a0,s5
    5d6c:	00000097          	auipc	ra,0x0
    5d70:	e58080e7          	jalr	-424(ra) # 5bc4 <putc>
  putc(fd, 'x');
    5d74:	07800593          	li	a1,120
    5d78:	8556                	mv	a0,s5
    5d7a:	00000097          	auipc	ra,0x0
    5d7e:	e4a080e7          	jalr	-438(ra) # 5bc4 <putc>
    5d82:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5d84:	00003b97          	auipc	s7,0x3
    5d88:	ae4b8b93          	addi	s7,s7,-1308 # 8868 <digits>
    5d8c:	03c9d793          	srli	a5,s3,0x3c
    5d90:	97de                	add	a5,a5,s7
    5d92:	0007c583          	lbu	a1,0(a5)
    5d96:	8556                	mv	a0,s5
    5d98:	00000097          	auipc	ra,0x0
    5d9c:	e2c080e7          	jalr	-468(ra) # 5bc4 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5da0:	0992                	slli	s3,s3,0x4
    5da2:	397d                	addiw	s2,s2,-1
    5da4:	fe0914e3          	bnez	s2,5d8c <vprintf+0x10c>
        printptr(fd, va_arg(ap, uint64));
    5da8:	8be2                	mv	s7,s8
      state = 0;
    5daa:	4981                	li	s3,0
    5dac:	6c02                	ld	s8,0(sp)
    5dae:	bf11                	j	5cc2 <vprintf+0x42>
        s = va_arg(ap, char*);
    5db0:	008b8993          	addi	s3,s7,8
    5db4:	000bb903          	ld	s2,0(s7)
        if(s == 0)
    5db8:	02090163          	beqz	s2,5dda <vprintf+0x15a>
        while(*s != 0){
    5dbc:	00094583          	lbu	a1,0(s2)
    5dc0:	c9a5                	beqz	a1,5e30 <vprintf+0x1b0>
          putc(fd, *s);
    5dc2:	8556                	mv	a0,s5
    5dc4:	00000097          	auipc	ra,0x0
    5dc8:	e00080e7          	jalr	-512(ra) # 5bc4 <putc>
          s++;
    5dcc:	0905                	addi	s2,s2,1
        while(*s != 0){
    5dce:	00094583          	lbu	a1,0(s2)
    5dd2:	f9e5                	bnez	a1,5dc2 <vprintf+0x142>
        s = va_arg(ap, char*);
    5dd4:	8bce                	mv	s7,s3
      state = 0;
    5dd6:	4981                	li	s3,0
    5dd8:	b5ed                	j	5cc2 <vprintf+0x42>
          s = "(null)";
    5dda:	00002917          	auipc	s2,0x2
    5dde:	61e90913          	addi	s2,s2,1566 # 83f8 <malloc+0x24c2>
        while(*s != 0){
    5de2:	02800593          	li	a1,40
    5de6:	bff1                	j	5dc2 <vprintf+0x142>
        putc(fd, va_arg(ap, uint));
    5de8:	008b8913          	addi	s2,s7,8
    5dec:	000bc583          	lbu	a1,0(s7)
    5df0:	8556                	mv	a0,s5
    5df2:	00000097          	auipc	ra,0x0
    5df6:	dd2080e7          	jalr	-558(ra) # 5bc4 <putc>
    5dfa:	8bca                	mv	s7,s2
      state = 0;
    5dfc:	4981                	li	s3,0
    5dfe:	b5d1                	j	5cc2 <vprintf+0x42>
        putc(fd, c);
    5e00:	02500593          	li	a1,37
    5e04:	8556                	mv	a0,s5
    5e06:	00000097          	auipc	ra,0x0
    5e0a:	dbe080e7          	jalr	-578(ra) # 5bc4 <putc>
      state = 0;
    5e0e:	4981                	li	s3,0
    5e10:	bd4d                	j	5cc2 <vprintf+0x42>
        putc(fd, '%');
    5e12:	02500593          	li	a1,37
    5e16:	8556                	mv	a0,s5
    5e18:	00000097          	auipc	ra,0x0
    5e1c:	dac080e7          	jalr	-596(ra) # 5bc4 <putc>
        putc(fd, c);
    5e20:	85ca                	mv	a1,s2
    5e22:	8556                	mv	a0,s5
    5e24:	00000097          	auipc	ra,0x0
    5e28:	da0080e7          	jalr	-608(ra) # 5bc4 <putc>
      state = 0;
    5e2c:	4981                	li	s3,0
    5e2e:	bd51                	j	5cc2 <vprintf+0x42>
        s = va_arg(ap, char*);
    5e30:	8bce                	mv	s7,s3
      state = 0;
    5e32:	4981                	li	s3,0
    5e34:	b579                	j	5cc2 <vprintf+0x42>
    5e36:	74e2                	ld	s1,56(sp)
    5e38:	79a2                	ld	s3,40(sp)
    5e3a:	7a02                	ld	s4,32(sp)
    5e3c:	6ae2                	ld	s5,24(sp)
    5e3e:	6b42                	ld	s6,16(sp)
    5e40:	6ba2                	ld	s7,8(sp)
    }
  }
}
    5e42:	60a6                	ld	ra,72(sp)
    5e44:	6406                	ld	s0,64(sp)
    5e46:	7942                	ld	s2,48(sp)
    5e48:	6161                	addi	sp,sp,80
    5e4a:	8082                	ret

0000000000005e4c <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    5e4c:	715d                	addi	sp,sp,-80
    5e4e:	ec06                	sd	ra,24(sp)
    5e50:	e822                	sd	s0,16(sp)
    5e52:	1000                	addi	s0,sp,32
    5e54:	e010                	sd	a2,0(s0)
    5e56:	e414                	sd	a3,8(s0)
    5e58:	e818                	sd	a4,16(s0)
    5e5a:	ec1c                	sd	a5,24(s0)
    5e5c:	03043023          	sd	a6,32(s0)
    5e60:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    5e64:	8622                	mv	a2,s0
    5e66:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5e6a:	00000097          	auipc	ra,0x0
    5e6e:	e16080e7          	jalr	-490(ra) # 5c80 <vprintf>
}
    5e72:	60e2                	ld	ra,24(sp)
    5e74:	6442                	ld	s0,16(sp)
    5e76:	6161                	addi	sp,sp,80
    5e78:	8082                	ret

0000000000005e7a <printf>:

void
printf(const char *fmt, ...)
{
    5e7a:	711d                	addi	sp,sp,-96
    5e7c:	ec06                	sd	ra,24(sp)
    5e7e:	e822                	sd	s0,16(sp)
    5e80:	1000                	addi	s0,sp,32
    5e82:	e40c                	sd	a1,8(s0)
    5e84:	e810                	sd	a2,16(s0)
    5e86:	ec14                	sd	a3,24(s0)
    5e88:	f018                	sd	a4,32(s0)
    5e8a:	f41c                	sd	a5,40(s0)
    5e8c:	03043823          	sd	a6,48(s0)
    5e90:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5e94:	00840613          	addi	a2,s0,8
    5e98:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    5e9c:	85aa                	mv	a1,a0
    5e9e:	4505                	li	a0,1
    5ea0:	00000097          	auipc	ra,0x0
    5ea4:	de0080e7          	jalr	-544(ra) # 5c80 <vprintf>
}
    5ea8:	60e2                	ld	ra,24(sp)
    5eaa:	6442                	ld	s0,16(sp)
    5eac:	6125                	addi	sp,sp,96
    5eae:	8082                	ret

0000000000005eb0 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    5eb0:	1141                	addi	sp,sp,-16
    5eb2:	e406                	sd	ra,8(sp)
    5eb4:	e022                	sd	s0,0(sp)
    5eb6:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5eb8:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5ebc:	00003797          	auipc	a5,0x3
    5ec0:	9c47b783          	ld	a5,-1596(a5) # 8880 <freep>
    5ec4:	a02d                	j	5eee <free+0x3e>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5ec6:	4618                	lw	a4,8(a2)
    5ec8:	9f2d                	addw	a4,a4,a1
    5eca:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5ece:	6398                	ld	a4,0(a5)
    5ed0:	6310                	ld	a2,0(a4)
    5ed2:	a83d                	j	5f10 <free+0x60>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5ed4:	ff852703          	lw	a4,-8(a0)
    5ed8:	9f31                	addw	a4,a4,a2
    5eda:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    5edc:	ff053683          	ld	a3,-16(a0)
    5ee0:	a091                	j	5f24 <free+0x74>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5ee2:	6398                	ld	a4,0(a5)
    5ee4:	00e7e463          	bltu	a5,a4,5eec <free+0x3c>
    5ee8:	00e6ea63          	bltu	a3,a4,5efc <free+0x4c>
{
    5eec:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5eee:	fed7fae3          	bgeu	a5,a3,5ee2 <free+0x32>
    5ef2:	6398                	ld	a4,0(a5)
    5ef4:	00e6e463          	bltu	a3,a4,5efc <free+0x4c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5ef8:	fee7eae3          	bltu	a5,a4,5eec <free+0x3c>
  if(bp + bp->s.size == p->s.ptr){
    5efc:	ff852583          	lw	a1,-8(a0)
    5f00:	6390                	ld	a2,0(a5)
    5f02:	02059813          	slli	a6,a1,0x20
    5f06:	01c85713          	srli	a4,a6,0x1c
    5f0a:	9736                	add	a4,a4,a3
    5f0c:	fae60de3          	beq	a2,a4,5ec6 <free+0x16>
    bp->s.ptr = p->s.ptr->s.ptr;
    5f10:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5f14:	4790                	lw	a2,8(a5)
    5f16:	02061593          	slli	a1,a2,0x20
    5f1a:	01c5d713          	srli	a4,a1,0x1c
    5f1e:	973e                	add	a4,a4,a5
    5f20:	fae68ae3          	beq	a3,a4,5ed4 <free+0x24>
    p->s.ptr = bp->s.ptr;
    5f24:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    5f26:	00003717          	auipc	a4,0x3
    5f2a:	94f73d23          	sd	a5,-1702(a4) # 8880 <freep>
}
    5f2e:	60a2                	ld	ra,8(sp)
    5f30:	6402                	ld	s0,0(sp)
    5f32:	0141                	addi	sp,sp,16
    5f34:	8082                	ret

0000000000005f36 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    5f36:	7139                	addi	sp,sp,-64
    5f38:	fc06                	sd	ra,56(sp)
    5f3a:	f822                	sd	s0,48(sp)
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5f42:	02051993          	slli	s3,a0,0x20
    5f46:	0209d993          	srli	s3,s3,0x20
    5f4a:	09bd                	addi	s3,s3,15
    5f4c:	0049d993          	srli	s3,s3,0x4
    5f50:	2985                	addiw	s3,s3,1
    5f52:	894e                	mv	s2,s3
  if((prevp = freep) == 0){
    5f54:	00003517          	auipc	a0,0x3
    5f58:	92c53503          	ld	a0,-1748(a0) # 8880 <freep>
    5f5c:	c905                	beqz	a0,5f8c <malloc+0x56>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5f5e:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5f60:	4798                	lw	a4,8(a5)
    5f62:	09377a63          	bgeu	a4,s3,5ff6 <malloc+0xc0>
    5f66:	f426                	sd	s1,40(sp)
    5f68:	e852                	sd	s4,16(sp)
    5f6a:	e456                	sd	s5,8(sp)
    5f6c:	e05a                	sd	s6,0(sp)
  if(nu < 4096)
    5f6e:	8a4e                	mv	s4,s3
    5f70:	6705                	lui	a4,0x1
    5f72:	00e9f363          	bgeu	s3,a4,5f78 <malloc+0x42>
    5f76:	6a05                	lui	s4,0x1
    5f78:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    5f7c:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    5f80:	00003497          	auipc	s1,0x3
    5f84:	90048493          	addi	s1,s1,-1792 # 8880 <freep>
  if(p == (char*)-1)
    5f88:	5afd                	li	s5,-1
    5f8a:	a089                	j	5fcc <malloc+0x96>
    5f8c:	f426                	sd	s1,40(sp)
    5f8e:	e852                	sd	s4,16(sp)
    5f90:	e456                	sd	s5,8(sp)
    5f92:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
    5f94:	00009797          	auipc	a5,0x9
    5f98:	10c78793          	addi	a5,a5,268 # f0a0 <base>
    5f9c:	00003717          	auipc	a4,0x3
    5fa0:	8ef73223          	sd	a5,-1820(a4) # 8880 <freep>
    5fa4:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5fa6:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5faa:	b7d1                	j	5f6e <malloc+0x38>
        prevp->s.ptr = p->s.ptr;
    5fac:	6398                	ld	a4,0(a5)
    5fae:	e118                	sd	a4,0(a0)
    5fb0:	a8b9                	j	600e <malloc+0xd8>
  hp->s.size = nu;
    5fb2:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5fb6:	0541                	addi	a0,a0,16
    5fb8:	00000097          	auipc	ra,0x0
    5fbc:	ef8080e7          	jalr	-264(ra) # 5eb0 <free>
  return freep;
    5fc0:	6088                	ld	a0,0(s1)
      if((p = morecore(nunits)) == 0)
    5fc2:	c135                	beqz	a0,6026 <malloc+0xf0>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5fc4:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5fc6:	4798                	lw	a4,8(a5)
    5fc8:	03277363          	bgeu	a4,s2,5fee <malloc+0xb8>
    if(p == freep)
    5fcc:	6098                	ld	a4,0(s1)
    5fce:	853e                	mv	a0,a5
    5fd0:	fef71ae3          	bne	a4,a5,5fc4 <malloc+0x8e>
  p = sbrk(nu * sizeof(Header));
    5fd4:	8552                	mv	a0,s4
    5fd6:	00000097          	auipc	ra,0x0
    5fda:	bd6080e7          	jalr	-1066(ra) # 5bac <sbrk>
  if(p == (char*)-1)
    5fde:	fd551ae3          	bne	a0,s5,5fb2 <malloc+0x7c>
        return 0;
    5fe2:	4501                	li	a0,0
    5fe4:	74a2                	ld	s1,40(sp)
    5fe6:	6a42                	ld	s4,16(sp)
    5fe8:	6aa2                	ld	s5,8(sp)
    5fea:	6b02                	ld	s6,0(sp)
    5fec:	a03d                	j	601a <malloc+0xe4>
    5fee:	74a2                	ld	s1,40(sp)
    5ff0:	6a42                	ld	s4,16(sp)
    5ff2:	6aa2                	ld	s5,8(sp)
    5ff4:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    5ff6:	fae90be3          	beq	s2,a4,5fac <malloc+0x76>
        p->s.size -= nunits;
    5ffa:	4137073b          	subw	a4,a4,s3
    5ffe:	c798                	sw	a4,8(a5)
        p += p->s.size;
    6000:	02071693          	slli	a3,a4,0x20
    6004:	01c6d713          	srli	a4,a3,0x1c
    6008:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    600a:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    600e:	00003717          	auipc	a4,0x3
    6012:	86a73923          	sd	a0,-1934(a4) # 8880 <freep>
      return (void*)(p + 1);
    6016:	01078513          	addi	a0,a5,16
  }
}
    601a:	70e2                	ld	ra,56(sp)
    601c:	7442                	ld	s0,48(sp)
    601e:	7902                	ld	s2,32(sp)
    6020:	69e2                	ld	s3,24(sp)
    6022:	6121                	addi	sp,sp,64
    6024:	8082                	ret
    6026:	74a2                	ld	s1,40(sp)
    6028:	6a42                	ld	s4,16(sp)
    602a:	6aa2                	ld	s5,8(sp)
    602c:	6b02                	ld	s6,0(sp)
    602e:	b7f5                	j	601a <malloc+0xe4>
