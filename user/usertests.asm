...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
      ...
      5c:	70078793          	addi	a5,a5,1792 # 9758 <uninit>
      60:	0000c697          	auipc	a3,0xc
      64:	e0868693          	addi	a3,a3,-504 # be68 <buf>
    if(uninit[i] != '\0'){
...
0000000000000264 <bigwrite>:
{
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     29c:	bd0a0a13          	addi	s4,s4,-1072 # be68 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2a0:	6b0d                	lui	s6,0x3
...
0000000000000818 <writetest>:
{
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8b6:	5b658593          	addi	a1,a1,1462 # be68 <buf>
...
00000000000009a8 <writebig>:
{
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9d8:	49490913          	addi	s2,s2,1172 # be68 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a2a:	44290913          	addi	s2,s2,1090 # be68 <buf>
  if(fd < 0){
...
0000000000000b5e <unlinkread>:
{
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c06:	26658593          	addi	a1,a1,614 # be68 <buf>
     c0a:	8526                	mv	a0,s1
...
0000000000000d14 <linktest>:
{
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     dde:	08e58593          	addi	a1,a1,142 # be68 <buf>
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1144:	b5b48493          	addi	s1,s1,-1189 # ffffffffeaeb0b5b <__BSS_END__+0xffffffffeaea1ce3>
...
badarg(char *s)
{
    ...
    1184:	35048493          	addi	s1,s1,848 # c350 <buf+0x4e8>
...
00000000000011ba <copyinstr2>:
{
  ...
  if(pid == 0){
    ...
    1252:	50278793          	addi	a5,a5,1282 # 8750 <big.0>
    1256:	00008697          	auipc	a3,0x8
    125a:	4fa68693          	addi	a3,a3,1274 # 9750 <__global_pointer$+0x90f>
      big[i] = 'x';
    ...
    1270:	4e078223          	sb	zero,1252(a5) # 9750 <__global_pointer$+0x90f>
...
0000000000001758 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    17a0:	6cca8a93          	addi	s5,s5,1740 # be68 <buf>
    17a4:	864a                	mv	a2,s2
    17a6:	85d6                	mv	a1,s5
    ...
    17bc:	6b070713          	addi	a4,a4,1712 # be68 <buf>
    ...
    182e:	63eb0b13          	addi	s6,s6,1598 # be68 <buf>
...
0000000000001de4 <linkunlink>:
{
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e2e:	e6da0a1b          	addiw	s4,s4,-403 # 41c64e6d <__BSS_END__+0x41c55ff5>
...
0000000000001ee8 <manywrites>:
{
  ...
  exit(0);
    ...
    1f8e:	edeb0b13          	addi	s6,s6,-290 # be68 <buf>
...
0000000000002118 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2134:	35098993          	addi	s3,s3,848 # c350 <buf+0x4e8>
    2138:	1003d937          	lui	s2,0x1003d
    213c:	090e                	slli	s2,s2,0x3
    213e:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002e608>
    pid = fork();
...
0000000000002272 <bigargtest>:
{
  ...
  close(fd);
    ...
    22da:	37a78793          	addi	a5,a5,890 # 8650 <args.1>
    22de:	00006697          	auipc	a3,0x6
    22e2:	46a68693          	addi	a3,a3,1130 # 8748 <args.1+0xf8>
    ...
    22fa:	35a58593          	addi	a1,a1,858 # 8650 <args.1>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    23b6:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <__BSS_END__+0xffffffffffff0188>
    23ba:	85a6                	mv	a1,s1
...
00000000000026a6 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    26e2:	6705                	lui	a4,0x1
      *b = 99;
    26e4:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff1188>
    for(b = a; b < a+TOOMUCH; b += 4096){
...
0000000000002844 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    28a6:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f1187>
  a = sbrk(0);
    28aa:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    290a:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f1187>
...
0000000000002b4a <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2c10:	8007879b          	addiw	a5,a5,-2048 # a800 <uninit+0x10a8>
...
0000000000002d34 <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    2d40:	0511                	addi	a0,a0,4 # ffffffff80000004 <__BSS_END__+0xffffffff7fff118c>
...
0000000000003266 <subdir>:
{
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    334a:	b2258593          	addi	a1,a1,-1246 # be68 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    3360:	b0c74703          	lbu	a4,-1268(a4) # be68 <buf>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    342a:	a4258593          	addi	a1,a1,-1470 # be68 <buf>
...
000000000000418a <preempt>:
{
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    428c:	be058593          	addi	a1,a1,-1056 # be68 <buf>
...
00000000000043de <sbrkfail>:
{
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    455e:	6705                	lui	a4,0x1
      n += *(a+i);
    4560:	0007c683          	lbu	a3,0(a5) # 6400000 <__BSS_END__+0x63f1188>
...
00000000000047fc <fourfiles>:
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    489c:	5d0a0a13          	addi	s4,s4,1488 # be68 <buf>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    499c:	4d078793          	addi	a5,a5,1232 # be68 <buf>
...
0000000000004d84 <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4dc4:	0a890913          	addi	s2,s2,168 # be68 <buf>
  for(i = 0; i < N; i++){
    4dc8:	4a51                	li	s4,20
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4e22:	04a90913          	addi	s2,s2,74 # be68 <buf>
  if(fd < 0){
...
0000000000004f64 <fsfull>:
{
  ...
  printf("fsfull test finished\n");
    ...
    50b8:	db4a8a93          	addi	s5,s5,-588 # be68 <buf>
      if(cc < BSIZE)
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    5c80:	9cc7b783          	ld	a5,-1588(a5) # 8648 <freep>
    ...
    5ca8:	00e6ea63          	bltu	a3,a4,5cbc <free+0x4a>
{
  ...
  freep = p;
    ...
    5cea:	96f73123          	sd	a5,-1694(a4) # 8648 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    5d14:	93853503          	ld	a0,-1736(a0) # 8648 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    5d44:	90890913          	addi	s2,s2,-1784 # 8648 <freep>
  if(p == (char*)-1)
    5d48:	5afd                	li	s5,-1
    ...
    5d58:	11478793          	addi	a5,a5,276 # ee68 <base>
    5d5c:	00003717          	auipc	a4,0x3
    5d60:	8ef73623          	sd	a5,-1812(a4) # 8648 <freep>
  ...
  if(p == (char*)-1)
    ...
    5dd6:	86a73b23          	sd	a0,-1930(a4) # 8648 <freep>
      return (void*)(p + 1);
